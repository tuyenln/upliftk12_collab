               ...
               <div class="col-12 col-sm-12 col-md-12 col-lg-9 mrgn-b-2">
                  <div class="team-detail-content nopaddingtop">
                     <div class="clearfix header-section-content">
                        <h3 class="title-content">{{ isset($aRow) ? 'Edit' : 'Add' }} Principal</h3>
                     </div>
                     <div class="sec-content fw-ct">
                        ...
                        @if(isset($aRow))
                        <div class="row">
                        <form method="POST"  action="{{ route('admin.principal.update',$aRow->id) }}" enctype="multipart/form-data" style="width:100%;">
                           @method('PUT')
                        @else
                        <form method="POST"  action="{{ route('admin.principal.store') }}" enctype="multipart/form-data" style="width:100%;">
                        @endif
                           @csrf
                           <div class="col-md-12">
