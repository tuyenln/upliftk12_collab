         ...
         <div class="membersingle-info team-detail-space">
            <div class="row align-items-start">
               ...
               <div class="col-12 col-sm-12 col-md-12 col-lg-9 mrgn-b-2">
                  ...
                  <form class="form-horizontal form-label-left" method ="post" action="{{url('add')}}" enctype="multipart/form-data" >
                     @csrf
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input class="form-control @error('first_name') is-invalid @enderror" name="first_name" placeholder="First Name" type="text"
                              value="{{ old('first_name') }}" autocomplete="first_name" autofocus />  @error('first_name')
                           <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                           </span>
                           @enderror
