                                    ...
                                    @endif
                                        ...
                                        @if($user->is_admin)
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label class="control-label" for="name">State Name <span
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($states as $state)
                                                            <option
                                                                value="{{ $state->name }}" {{ (isset($aRow) && $aRow->state == $state->name) ? 'selected' : '' }}>{{ $state->name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($districts as $districts)
                                                            <option
                                                                value="{{$districts->id}}" {{ (isset($aRow) && $aRow->school_info->district == $districts->id) ? 'selected' : '' }}>{{$districts->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('district_name')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        @if(isset($aRow))
                                                            <option value="{{ $aRow->school_info->id }}"
                                                                    selected="">{{ $aRow->school_info->school }}</option>
                                                        @endif
                                                    </select>
                                                    @error('school_name')
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        @else
                                            ...
                                            <input type="hidden" name="school_name"
                                                   value="{{ $user->school_district }}">
                                        @endif
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                <label class="control-label" for="name"> First Name<span
                                                        class="required">*</span>
                                                </label>
                                                <input
                                                    class="form-control @error('first_name') is-invalid @enderror"
                                                    name="first_name" placeholder="First Name" type="text"
                                                    value="{{ $aRow->first_name ?? old('first_name') }}"
                                                    autocomplete="first_name"
                                                    autofocus/> @error('first_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                @enderror
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="item form-group">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ $aRow->last_name ?? old('last_name') }}"
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class=" form-group">
                                                ...
                                                <input
                                                    ...
                                                    name="email" value="{{ $aRow->email ?? old('email') }}"
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                <label class="control-label " for="name"> Re-enter password
                                                    <span class="required">*</span>
                                                </label>
                                                <input
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="reset" name="add_category"
                                                       class="btn btn-danger" value="Cancel"/>
                                                <a href="{{route('admin.teacher.addSchools')}}" class="btn btn-info pull-right">Add Schools</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
