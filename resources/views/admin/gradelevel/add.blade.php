               ...
               <div class="col-12 col-sm-12 col-md-12 col-lg-9 mrgn-b-2">
                  <div class="team-detail-content nopaddingtop">
                     <div class="clearfix header-section-content">
                        <h3 class="title-content">{{ $aRow ? "Edit" : "Add New" }} Gradelevel</h3>
                     </div>
                           ...
                           <div class="row">
                                 ...
                                 <div class="x_content">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                       @if($aRow)
                                       <form method="POST"  action="{{ route('admin.gradelevel.update',$aRow->id) }}" enctype="multipart/form-data" style="width:100%;">
                                          @method('PUT')
                                          @else
                                       <form method="POST"  action="{{ route('admin.gradelevel.store') }}" enctype="multipart/form-data" style="width:100%;">
                                          @endif
                                          @csrf
