...
<div class="container">
    <div class="row align-items-start">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-lg-offset-3 mrgn-b-2">
            <div>
                <h3 class="title-content text-center" style="margin-bottom: 20px;">Add New Class</h3>
			...
			@csrf
				<div class="form-group">    
					...
					<input type="text" name="name" class="form-control" required placeholder="Class Name">
				</div>
