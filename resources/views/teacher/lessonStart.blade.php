    ...
    <body>
        <header>
            <div class="nav">
                ...
                <button class="end-btn pull-right disabled" onclick="endlesson()" id="end_lesson">END LESSON</button>
                <a class="end-btn pull-right" onclick="leavefeedback()">LEAVE FEEDBACK</a>
            </div>
        </header>
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div style="width: 100%; display: flex; position: relative;">
                    ...
                    <div id="button" style="position: absolute; left: 5px; top: calc(30% - 40px);">
                        <button class="btn btn-primary refreshall" style="font-size: 12px;">Sync All Students to Slide</button>
                    </div>
                    <div id="teacher_div" style="position: absolute; left: 5px; top: 30%;">
                        <div class="def-ava-div" id="t_def_ava_div">
                            <img class="def-ava-img" style="width: 160px; height: auto; cursor: pointer;" src="{{$user->avatar ? url($user->avatar) : url('public/images/noavatar.png')}}" alt="">
                        </div>
                    </div>
