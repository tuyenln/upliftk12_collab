...
<div class="x_content">
    <div class="clearfix" >
        <a href="{{ route('teacher.student.create') }}" class="btn btn-primary pull-right">Add Student</a>
        <a href="{{ route('teacher.student.uploadcsv') }}" class="btn btn-primary pull-right">Upload Csv</a>
    </div>
    @if(count($aRows))
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$aRow->name}}</td>
                <td>
                    <a href="{{ route('teacher.student.edit',$aRow->id) }}">Edit</i></a>
