      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
             <a href="index.php" target="blank" class="site_title"><img src="{{url('public/assets/images/logo-dark.png')}}" style="height: 50px; width: 100px"> <br></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="{{ url('principle/logout') }}" style="color: red;" ><i class="fa fa-sign-out" aria-hidden="true"></i>LOGOUT</a></li>
