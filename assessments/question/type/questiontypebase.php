...
;
        ...
        $arr['case_data']=implode(',',$form->md_case);
        $arr['case_level']=$form->md_level;
        $arrDis=$form->distrcator;
        ...
        if (empty($question->id)) {
            ...
            _insertCase($arr);
            _insertDistractor($arrDis,$question_id);
            $newquestion = true;
        }
        ...
        $question_id=$question->id;
        _updateCase($arr);
        _updateDistractor($arrDis,$question_id);
