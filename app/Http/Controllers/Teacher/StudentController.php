...
class StudentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('teacher.student.list',compact('aRows'));
    }
    ...
    public function uploadcsv(Request $request)
    {
			...
			if($aVals)
			{
				foreach ($aVals as $key => $aVal) {
					...
					if(!$aChk)
					{
	        			...
	        			User::create($aRow);
	        			//return redirect('teacher/student')->with('message', 'New Student Added Successfully.');
					}
				}
        ...
        return view('teacher.student.uploadcsv', compact('user', 'classes'));
    }
    ...
    public function create()
    {
        ...
        $user = Auth::user();
        $classes = SchoolClass::where('teacher_id', '=', $user->id)->get();
        return view('teacher.student.add',compact('aRow', 'user', 'classes'));
    }
    public function store(Request $request)
    {
        ...
        User::create($aRows);
        return redirect('teacher/home')->with('message', 'New Student Added Successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('teacher/home')->with('message', 'Student updated Successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        $aRow = User::findOrFail($id);
        $aRow->delete();
        return redirect('teacher/student')->with('message', 'Student deleted Successfully.');
    }
