...
(function(t, e, i, r, n, o) {
    ...
    function c(t, i) {
        ...
        return r.width = i.width, r.height = i.height, D("Cropping canvas at:", "left:", i.left, "top:", i.top, "width:", o - n, "height:", a - s), D("Resulting crop with width", i.width, "and height", i.height, " with x", n, "and y", s), r.getContext("2d").drawImage(t, n, s, o - n, a - s, i.x, i.y, o - n, a - s), r
    }
    function l(t) {
    ...
    function p(t, i) {
        for (var r = 3 === t.nodeType ? e.createTextNode(t.nodeValue) : t.cloneNode(!1), n = t.firstChild; n;)
            !0 !== i && 1 === n.nodeType && "SCRIPT" === n.nodeName || r.appendChild(p(n, i)), n = n.nextSibling;
        return r
    }
    function g(t, e, i, r, n, o, s) {
        ...
        return h.className = "html2canvas-container", h.style.visibility = "hidden", h.style.position = "fixed", h.style.left = "-10000px", h.style.top = "0px", h.style.border = "0", h.width = i, h.height = r, h.scrolling = "no", e.body.appendChild(h), new Promise(function(e) {
            var i = h.contentWindow.document;
            m(t.documentElement, a, "textarea"), m(t.documentElement, a, "select"), h.contentWindow.onload = h.onload = function() {
                var r = setInterval(function() {
                    i.body.childNodes.length > 0 && (w(t, i), clearInterval(r), "view" === n.type && h.contentWindow.scrollTo(o, s), e(h))
                }, 50)
            }, i.open(), i.write("<!DOCTYPE html><html></html>"), v(t, o, s), i.replaceChild(!0 === n.javascriptEnabled ? i.adoptNode(a) : S(i.adoptNode(a)), i.documentElement), i.close()
        })
    }
    function m(t, e, i) {
        for (var r = t.getElementsByTagName(i), n = e.getElementsByTagName(i), o = r.length, s = 0; s < o; s++)
            n[s].value = r[s].value
    }
    function v(t, e, i) {
    ...
    function y(t) {
        return function(i) {
            ...
            try {
                ...
                D("DOMParser not supported, falling back to createHTMLDocument"), r = e.implementation.createHTMLDocument("");
                try {
                    r.open(), r.write(i), r.close()
                } catch (t) {
                    D("createHTMLDocument write not supported, falling back to document.body.innerHTML"), r.body.innerHTML = i
                }
            }
            var o = r.querySelector("base");
            if (!o || !o.href.host) {
                var s = r.createElement("base");
                s.href = t, r.head.insertBefore(s, r.head.firstChild)
            }
            return r
        }
    }
    ...
    function w(t, e) {
        [].slice.call(t.querySelectorAll("[" + qt + "]"), 0).forEach(function(t) {
            try {
    ...
    function _(t) {
        ...
        return i.href = t, i.href = i.href, i
    }
    function T(t) {
    ...
    function O(t) {
        if (this.src = t, D("DummyImageContainer for", t), !this.promise || !this.image) {
            D("Initiating DummyImageContainer"), O.prototype.image = new Image;
            var e = this.image;
            O.prototype.promise = new Promise(function(t, i) {
                e.onload = t, e.onerror = i, e.src = f(), !0 === e.complete && t(e)
            })
        }
    }
    function k(t, i) {
    ...
    function I(t, e) {
        ...
        this.tainted = null, this.promise = new Promise(function(r, n) {
            i.image.onload = r, i.image.onerror = n, e && (i.image.crossOrigin = "anonymous"), i.image.src = t, !0 === i.image.complete && r(i.image)
        })
    }
    function P(e, i) {
        this.link = null, this.options = e, this.support = i, this.origin = this.getOrigin(t.location.href)
    }
    function M(t) {
        ...
        e ? t.args[0].split(" ").reverse().forEach(function(t) {
            ...
            case "to":
                var e = this.y0,
                    i = this.x0;
                this.y0 = this.y1, this.x0 = this.x1, this.x1 = i, this.y1 = e
            }
    ...
    function N(t) {
        ...
        return a = [], e = r = i = o = "", t.split("").forEach(function(t) {
            if (!(0 === c && " \r\n\t".indexOf(t) > -1)) {
                switch (t) {
                case '"':
                    s ? s === t && (s = null) : s = t;
    ...
    function W(t, e, i, r, n) {
        D("Starting NodeParser"), this.renderer = e, this.options = n, this.range = null, this.support = i, this.renderQueue = [], this.stack = new Rt(!0, 1, t.ownerDocument, null);
        var o = new L(t, null);
        ...
        o.visibile = o.isElementVisible(), this.createPseudoHideStyles(t.ownerDocument), this.disableAnimations(t.ownerDocument), this.nodes = Ct([o].concat(this.getChildren(o)).filter(function(t) {
            return t.visible = t.isElementVisible()
        }).map(this.getPseudoElements, this)), this.fontMetrics = new E, D("Fetched nodes, total:", this.nodes.length), D("Calculate overflow clips"), this.calculateOverflowClips(), D("Start fetching images"), this.images = r.fetch(this.nodes.filter(pt)), this.ready = this.images.ready.then(yt(function() {
        ...
        return t.map(function(n, o) {
            if (n.width > 0) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    s = e.left + e.width - t[1].width, h = t[1].width, n.args = K({
                        c1: [s + h, a],
                    ...
                    break;
                case 2:
                    a = a + e.height - t[2].width, c = t[2].width, n.args = K({
                        c1: [s + h, a + c],
                        c2: [s, a + c],
                        c3: [s + t[3].width, a],
                        c4: [s + h - t[3].width, a]
    ...
    function K(t, e, i, r, n, o, s) {
        var a = [];
        return e[0] > 0 || e[1] > 0 ? (a.push(["line", r[1].start.x, r[1].start.y]), r[1].curveTo(a)) : a.push(["line", t.c1[0], t.c1[1]]), i[0] > 0 || i[1] > 0 ? (a.push(["line", o[0].start.x, o[0].start.y]), o[0].curveTo(a), a.push(["line", s[0].end.x, s[0].end.y]), s[0].curveToReversed(a)) : (a.push(["line", t.c2[0], t.c2[1]]), a.push(["line", t.c3[0], t.c3[1]])), e[0] > 0 || e[1] > 0 ? (a.push(["line", n[1].end.x, n[1].end.y]), n[1].curveToReversed(a)) : a.push(["line", t.c4[0], t.c4[1]]), a
    }
    function Z(t, e, i, r, n, o, s) {
        e[0] > 0 || e[1] > 0 ? (t.push(["line", r[0].start.x, r[0].start.y]), r[0].curveTo(t), r[1].curveTo(t)) : t.push(["line", o, s]), (i[0] > 0 || i[1] > 0) && t.push(["line", n[0].start.x, n[0].start.y])
    }
    function tt(t) {
    ...
    function at(t) {
        return ["TopLeft", "TopRight", "BottomRight", "BottomLeft"].map(function(e) {
            ...
            return i.length <= 1 && (i[1] = i[0]), i.map(xt)
        })
    }
    function ht(t) {
    ...
    function Tt(e) {
        for (var i, r = [], n = 0, o = !1; e.length;)
            Ot(e[n]) === o ? ((i = e.splice(0, n)).length && r.push(t.html2canvas.punycode.ucs2.encode(i)), o = !o, n = 0) : n++, n >= e.length && (i = e.splice(0, n)).length && r.push(t.html2canvas.punycode.ucs2.encode(i));
        return r
    }
    function Ot(t) {
    ...
    function Mt(t, i) {
        ...
        this.promise = new Promise(function(r, o) {
            n.image.crossOrigin = "Anonymous", n.image.onload = r, n.image.onerror = o, new At(t, i, e).then(function(t) {
                n.image.src = t
            }).catch(o)
        })
    }
    function Dt(t, e, i) {
        L.call(this, t, e), this.isPseudoElement = !0, this.before = ":before" === i
    }
    function Lt(t, e, i, r, n) {
        this.width = t, this.height = e, this.images = i, this.options = r, this.document = n
    }
    function Rt(t, e, i, r) {
        L.call(this, i, r), this.ownStacking = t, this.contexts = [], this.children = [], this.opacity = (this.parent ? this.parent.stack.opacity : 1) * e
    }
    function Bt(t) {
    ...
    function Nt(t) {
        var e,
            ...
            l = "";
        for (e = 0; e < c; e += 4)
            o = h.indexOf(t[e]) << 2 | (i = h.indexOf(t[e + 1])) >> 4, s = (15 & i) << 4 | (r = h.indexOf(t[e + 2])) >> 2, a = (3 & r) << 6 | (n = h.indexOf(t[e + 3])), l += 64 === r ? String.fromCharCode(o) : 64 === n || -1 === n ? String.fromCharCode(o, s) : String.fromCharCode(o, s, a);
        return l
    }
    function Gt(t, e) {
        this.src = t, this.image = null;
        ...
        this.promise = e ? new Promise(function(e, r) {
            i.image = new Image, i.image.onload = e, i.image.onerror = r, i.image.src = "data:image/svg+xml," + (new XMLSerializer).serializeToString(t), !0 === i.image.complete && e(i.image)
    ...
    function Vt(t) {
        j.apply(this, arguments), this.type = "linear" === t.args[0] ? this.TYPES.LINEAR : this.TYPES.RADIAL
    }
    function Wt(t) {
    ...
    function Yt(t, e) {
        Lt.apply(this, arguments), this.canvas = this.options.canvas || this.document.createElement("canvas"), this.options.canvas || (this.canvas.width = t, this.canvas.height = e), this.ctx = this.canvas.getContext("2d"), this.taintCtx = this.document.createElement("canvas").getContext("2d"), this.ctx.textBaseline = "bottom", this.variables = {}, D("Initialized CanvasRenderer with size", t, "x", e)
    }
    function Ht(t) {
        return t.length > 0
    }
    if (function() {
        ...
        function l(t, e) {
            1 === e.a ? d(t, e.b) : 2 === t.a ? p(t, e.b) : g(e, void 0, function(e) {
                u(t, e)
            }, function(e) {
                p(t, e)
            })
        ...
        function g(t, e, r, n) {
            var o = t.e,
                s = o.length;
            t.f = null, o[s] = e, o[s + 1] = r, o[s + 2] = n, 0 === s && t.a && i(m, t)
        }
        function m(t) {
            var e = t.e,
                i = t.a;
            if (0 !== e.length) {
                for (var r, n, o = t.b, s = 0; s < e.length; s += 3)
                    r = e[s], n = e[s + i], r ? b(i, r, n, o) : n(o);
                t.e.length = 0
            }
        }
        function v() {
        ...
        function b(t, e, i, r) {
            ...
            if (c) {
                ...
                if (n === A ? (h = !0, s = n.error, n = null) : a = !0, e === n)
                    return void p(e, new TypeError("A promises callback cannot return that same promise."))
            } else
                n = r, a = !0;
        ...
        function x(t, e, i, r) {
            this.n = t, this.c = new t(a, r), this.i = i, this.o(e) ? (this.m = e, this.d = this.length = e.length, this.l(), 0 === this.length ? d(this.c, this.b) : (this.length = this.length || 0, this.k(), 0 === this.d && d(this.c, this.b))) : p(this.c, this.p())
        }
        function w(t) {
        ...
        var S,
            ...
            k = Array(1e3);
        S = "undefined" != typeof process && "[object process]" === {}.toString.call(process) ? function() {
            process.nextTick(s)
        } : T ? function() {
            var t = 0,
                i = new T(s),
        ...
        x.prototype.o = function(t) {
            ...
            for (var t = this.length, e = this.c, i = this.m, r = 0; void 0 === e.a && r < t; r++)
                this.j(i[r], r)
            ...
            var r = this.c;
            void 0 === r.a && (this.d--, this.i && 2 === t ? p(r, i) : this.b[e] = this.h(i)), 0 === this.d && d(r, this.b)
        }, x.prototype.h = function(t) {
            return t
        }, x.prototype.q = function(t, e) {
            var i = this;
            g(t, void 0, function(t) {
                i.g(1, e, t)
            }, function(t) {
                i.g(2, e, t)
            })
        ...
        w.all = function(t, e) {
            ...
            for (var r = t.length, n = 0; void 0 === i.a && n < r; n++)
                g(this.resolve(t[n]), void 0, function(t) {
                    u(i, t)
                }, function(t) {
                    p(i, t)
                });
        ...
        var I = {
            ...
            polyfill: function() {
                var e;
                "Promise" in (e = void 0 !== r ? r : void 0 !== t && t.document ? t : self) && "resolve" in e.Promise && "reject" in e.Promise && "all" in e.Promise && "race" in e.Promise && function() {
                    var t;
        ...
        !function(t) {
            ...
            function s(t, e) {
                var i = t.split("@"),
                    r = "";
                return i.length > 1 && (r = i[0] + "@", t = i[1]), r + o(t.split(j), e).join(".")
            }
            function a(t) {
            ...
            function u(t, e, i) {
                var r = 0;
                for (t = i ? M(t / _) : t >> 1, t += M(t / e); t > P * S >> 1; r += x)
                    t = M(t / P);
            ...
            function f(t) {
                ...
                for (o = r > 0 ? r + 1 : 0; o < m;) {
                    for (s = v, a = 1, l = x; o >= m && e("invalid-input"), ((f = c(t.charCodeAt(o++))) >= x || f > M((y - v) / a)) && e("overflow"), v += f * a, d = l <= C ? w : l >= C + S ? S : l - C, !(f < d); l += x)
                        a > M(y / (p = x - d)) && e("overflow"), a *= p;
                    C = u(v - s, i = g.length + 1, 0 == s), M(v / i) > y - b && e("overflow"), b += M(v / i), v %= i, g.splice(v++, 0, b)
                }
                return h(g)
            }
            function d(t) {
                var i,
                    ...
                    C,
                    _ = [];
                for (m = (t = a(t)).length, i = O, r = 0, s = T, h = 0; h < m; ++h)
                    (g = t[h]) < 128 && _.push(D(g));
                for (n = o = _.length, o && _.push(k); n < m;) {
                    for (c = y, h = 0; h < m; ++h)
                        (g = t[h]) >= i && g < c && (c = g);
                    for (c - i > M((y - r) / (v = n + 1)) && e("overflow"), r += (c - i) * v, i = c, h = 0; h < m; ++h)
                        if ((g = t[h]) < i && ++r > y && e("overflow"), g == i) {
                            for (f = r, d = x; p = d <= s ? w : d >= s + S ? S : d - s, !(f < p); d += x)
                                C = f - p, b = x - p, _.push(D(l(p + C % b, 0))), f = M(C / b);
                            _.push(D(l(f, 0))), s = u(r, v, n == o), r = 0, ++n
                        }
                    ++r, ++i
                }
                return _.join("")
        ...
        t.html2canvas = function(i, r) {
            ...
            return l.setAttribute(Ut + n, n), s(l.ownerDocument, r, l.ownerDocument.defaultView.innerWidth, l.ownerDocument.defaultView.innerHeight, n).then(function(t) {
                if ("function" == typeof r.onrendered)
                    if (D("options.onrendered is deprecated, html2canvas returns a Promise containing the canvas"), void 0 === r.grabMouse || r.grabMouse) {
                        var e = new Image(25, 25);
                        e.onload = function() {
                            t.getContext("2d").drawImage(e, ae, he, 25, 25), r.onrendered(t)
        ...
        T.prototype.hex3 = function(t) {
            var e = null;
            return null !== (e = t.match(Qt)) && (this.r = parseInt(e[1][0] + e[1][0], 16), this.g = parseInt(e[1][1] + e[1][1], 16), this.b = parseInt(e[1][2] + e[1][2], 16)), null !== e
        };
        var Kt = /^#([a-f0-9]{6})$/i;
        ...
        T.prototype.rgba = function(t) {
            ...
            else if ("transparent" === t.toLowerCase())
        ...
        E.prototype.getMetrics = function(t, e) {
            return this.data[t + "-" + e] === o && (this.data[t + "-" + e] = new k(t, e)), this.data[t + "-" + e]
            ...
            return i.href = t, i.href = i.href, i.protocol + i.hostname + i.port
            ...
            var i,
                r = Promise.race([t.promise, new Promise(function(r, n) {
                    i = setTimeout(function() {
                        D("Timed out loading image", t), n(t)
                    }, e)
                })]).then(function(t) {
        ...
        }, (M.prototype = Object.create(j.prototype)).stepRegExp = /((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/, L.prototype.cloneTo = function(t) {
            ...
            return i = i[e || 0] || i[0] || "auto", 1 === (i = i.trim().split(" ")).length && (i = [i[0], i[0]]), i
        }, L.prototype.parseBackgroundSize = function(t, e, i) {
            var r,
                n,
                o = this.cssList("backgroundSize", i);
            if (F(o[0]))
            ...
            return n = "auto" === o[0] && "auto" === o[1] ? e.height : "auto" === o[1] ? r / e.width * e.height : F(o[1]) ? t.height * parseFloat(o[1]) / 100 : parseInt(o[1], 10), "auto" === o[0] && (r = n / e.height * e.width), {
                width: r,
                height: n
            }
            ...
            return n = F(s[0]) ? (t.width - (r || e).width) * (parseFloat(s[0]) / 100) : parseInt(s[0], 10), o = "auto" === s[1] ? n / e.width * e.height : F(s[1]) ? (t.height - (r || e).height) * parseFloat(s[1]) / 100 : parseInt(s[1], 10), "auto" === s[0] && (n = o / e.height * e.width), {
                left: n,
                top: o
            }
            ...
            var t = this.css("textShadow"),
                e = [];
            if (t && "none" !== t)
                for (var i = t.match(this.TEXT_SHADOW_PROPERTY), r = 0; i && r < i.length; r++) {
            ...
            return "SELECT" === this.node.tagName ? t = R(this.node) : "password" === this.node.type && (t = Array(t.length + 1).join("•")), 0 === t.length ? this.node.placeholder || "" : t
        }, L.prototype.MATRIX_PROPERTY = /(matrix)\((.+)\)/, L.prototype.TEXT_SHADOW_PROPERTY = /((rgba|rgb)\([^\)]+\)(\s-?\d+px){0,})/g, L.prototype.TEXT_SHADOW_VALUES = /(-?\d+px)|(#.+)|(rgb\(.+\))|(rgba\(.+\))/g, L.prototype.CLIP = /^rect\((\d+)px,? (\d+)px,? (\d+)px,? (\d+)px\)$/, W.prototype.calculateOverflowClips = function() {
            this.nodes.forEach(function(t) {
                if (pt(t)) {
                    gt(t) && t.appendToDOM(), t.borders = this.parseBorders(t);
                    var e = "hidden" === t.css("overflow") ? [t.borders.clip] : [],
                        i = t.parseClip();
                    i && -1 !== ["absolute", "fixed"].indexOf(t.css("position")) && e.push([["rect", t.bounds.left + i.left, t.bounds.top + i.top, i.right - i.left, i.bottom - i.top]]), t.clip = Y(t) ? t.parent.clip.concat(e) : e, t.backgroundClip = "hidden" !== t.css("overflow") ? t.clip.concat([t.borders.clip]) : t.clip, gt(t) && t.cleanDOM()
                } else
                    mt(t) && (t.clip = Y(t) ? t.parent.clip : []);
                gt(t) || (t.bounds = null)
            }, this)
        }, W.prototype.asyncRenderer = function(t, e, i) {
            i = i || Date.now(), this.paint(t[this.renderIndex++]), t.length === this.renderIndex ? e() : i + 20 > Date.now() ? this.asyncRenderer(t, e, i) : setTimeout(yt(function() {
            ...
            if (s.className = Dt.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + " " + Dt.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER, o)
                return s.src = N(n)[0].args[0], [a];
            var l = e.createTextNode(n);
            return s.appendChild(l), [a, new Xt(l, a)]
            ...
            t.cloneTo(i), (e ? i.getParentStack(this) : i.parent.stack).contexts.push(i), t.stack = i
            ...
            e.concat(n).concat(o).concat(s).concat(a).concat(h).concat(c).forEach(function(t) {
                this.renderQueue.push(t), nt(t) && (this.parse(t), this.renderQueue.push(new U))
            }, this)
            ...
            try {
                ...
                if (D(t), this.options.strict)
                    throw t
            }
        }, W.prototype.paintNode = function(t) {
            nt(t) && (this.renderer.setOpacity(t.opacity), this.renderer.ctx.save(), t.hasTransform() && this.renderer.setTransform(t.parseTransform())), "INPUT" === t.node.nodeName && "checkbox" === t.node.type ? this.paintCheckbox(t) : "INPUT" === t.node.nodeName && "radio" === t.node.type ? this.paintRadio(t) : this.paintElement(t)
            ...
            var e = t.parseBounds(),
                ...
                a = $(r, o, s);
            this.renderer.clip(t.backgroundClip, function() {
                this.renderer.rectangle(r.left + 1, r.top + 1, r.width - 2, r.height - 2, new T("#DEDEDE")), this.renderer.renderBorders(q(s, r, a, o)), t.node.checked && (this.renderer.font(new T("#424242"), "normal", "normal", "bold", i - 3 + "px", "arial"), this.renderer.text("✔", r.left + i / 6, r.top + i - 1))
            }, this)
        }, W.prototype.paintRadio = function(t) {
            var e = t.parseBounds(),
                i = Math.min(e.width, e.height) - 2;
            this.renderer.clip(t.backgroundClip, function() {
                this.renderer.circleStroke(e.left + 1, e.top + 1, i, new T("#DEDEDE"), 1, new T("#A5A5A5")), t.node.checked && this.renderer.circle(Math.ceil(e.left + i / 4) + 1, Math.ceil(e.top + i / 4) + 1, Math.floor(i / 2), new T("#424242"))
            }, this)
        }, W.prototype.paintFormValue = function(t) {
            var e = t.getValue();
            if (e.length > 0) {
                var i = t.node.ownerDocument,
                    r = i.createElement("html2canvaswrapper");
                ...
                var n = t.parseBounds();
                r.style.position = "fixed", r.style.left = n.left + "px", r.style.top = n.top + "px", r.textContent = e, i.body.appendChild(r), this.paintText(new Xt(r.firstChild, t)), i.body.removeChild(r)
            }
            ...
            this.renderer.font(e.parent.color("color"), e.parent.css("fontStyle"), e.parent.css("fontVariant"), n, o, s), a.length ? this.renderer.fontShadow(a[0].color, a[0].offsetX, a[0].offsetY, a[0].blur) : this.renderer.clearShadow(), this.renderer.clip(e.parent.clip, function() {
        ...
        W.prototype.parseBorders = function(t) {
            ...
            case "content-box":
            case "padding-box":
                Z(o, r[0], r[1], e.topLeftInner, e.topRightInner, n.left + i[3].width, n.top + i[0].width), Z(o, r[1], r[2], e.topRightInner, e.bottomRightInner, n.left + n.width - i[1].width, n.top + i[0].width), Z(o, r[2], r[3], e.bottomRightInner, e.bottomLeftInner, n.left + n.width - i[1].width, n.top + n.height - i[2].width), Z(o, r[3], r[0], e.bottomLeftInner, e.topLeftInner, n.left + i[3].width, n.top + n.height - i[2].width);
                break;
            default:
                Z(o, r[0], r[1], e.topLeftOuter, e.topRightOuter, n.left, n.top), Z(o, r[1], r[2], e.topRightOuter, e.bottomRightOuter, n.left + n.width, n.top), Z(o, r[2], r[3], e.bottomRightOuter, e.bottomLeftOuter, n.left + n.width, n.top + n.height), Z(o, r[3], r[0], e.bottomLeftOuter, e.topLeftOuter, n.left, n.top + n.height)
            }
            return o
        };
        var re = 0,
        ...
        Dt.prototype.cloneTo = function(t) {
        ...
        }, Dt.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE = "___html2canvas___pseudoelement_before", Dt.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER = "___html2canvas___pseudoelement_after", Lt.prototype.renderImage = function(t, e, i, r) {
            ...
            var e,
                i,
                r = !1;
            return t.createRange && (e = t.createRange()).getBoundingClientRect && ((i = t.createElement("boundtest")).style.height = "123px", i.style.display = "block", t.body.appendChild(i), e.selectNode(i), 123 === e.getBoundingClientRect().height && (r = !0), t.body.removeChild(i)), r
            ...
            return function(i, r) {
                ...
                e.image = n.lowerCanvasEl, n.setWidth(r.width).setHeight(r.height).add(html2canvas.fabric.util.groupSVGElements(i, r)).renderAll(), t(n.lowerCanvasEl)
            }
        }, Ft.prototype.decode64 = function(e) {
            return "function" == typeof t.atob ? t.atob(e) : Nt(e)
        }, Gt.prototype = Object.create(Ft.prototype), (Xt.prototype = Object.create(L.prototype)).applyTextTransform = function() {
        ...
        }, Vt.prototype = Object.create(j.prototype), (Yt.prototype = Object.create(Lt.prototype)).setFillStyle = function(t) {
            ...
            this.setFillStyle(r), this.ctx.beginPath(), this.ctx.arc(t + i / 2, e + i / 2, i / 2, 0, 2 * Math.PI, !0), this.ctx.closePath(), this.ctx.fill()
        }, Yt.prototype.circleStroke = function(t, e, i, r, n, o) {
            this.circle(t, e, i, r), this.ctx.strokeStyle = o.toString(), this.ctx.stroke()
            ...
            return n.width = i.width, n.height = i.height, n.getContext("2d").drawImage(r, 0, 0, r.width, r.height, 0, 0, i.width, i.height), n
        };
        var se = !!e.all;
        se || e.captureEvents(Event.MOUSEMOVE), e.addEventListener("mousemove", function(t) {
            return se ? (ae = event.clientX + e.body.scrollLeft, he = event.clientY + e.body.scrollTop) : (ae = t.pageX, he = t.pageY), ae < 0 && (ae = 0), he < 0 && (he = 0), !0
        }, !1);
        var ae = 0,
            he = 0
    } else
        (t || module.exports).html2canvas = function() {
    ...
    void 0 !== exports && (exports.fabric = fabric), void 0 !== document && void 0 !== window ? (fabric.document = document, fabric.window = window) : (fabric.document = require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"), fabric.window = fabric.document.createWindow()), fabric.isTouchSupported = "ontouchstart" in fabric.document.documentElement, fabric.isLikelyNode = "undefined" != typeof Buffer && void 0 === window, fabric.SHARED_ATTRIBUTES = ["display", "transform", "fill", "fill-opacity", "fill-rule", "opacity", "stroke", "stroke-dasharray", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width"], fabric.DPI = 96;
    var Cufon = function() {
        function t(t) {
            var e = this.face = t.face;
            this.glyphs = t.glyphs, this.w = t.w, this.baseSize = parseInt(e["units-per-em"], 10), this.family = e["font-family"].toLowerCase(), this.weight = e["font-weight"], this.style = e["font-style"] || "normal", this.viewBox = function() {
                ...
                return i.width = i.maxX - i.minX, i.height = i.maxY - i.minY, i.toString = function() {
                    return [this.minX, this.minY, this.width, this.height].join(" ")
                }, i
            }(), this.ascent = -parseInt(e.ascent, 10), this.descent = -parseInt(e.descent, 10), this.height = -this.ascent + this.descent
        }
        function e() {
            var t = {},
                e = {
            ...
            this.add = function(e) {
                (t[e.style] || (t[e.style] = {}))[e.weight] = e
                ...
                var o,
                    ...
                    h = [];
                a === undefined && (a = r > 400), 500 == r && (r = 400);
                for (var c in n)
                    c = parseInt(c, 10), (!o || c < o) && (o = c), (!s || c > s) && (s = c), h.push(c);
                return r < o && (r = o), r > s && (r = s), h.sort(function(t, e) {
        ...
        function o(t) {
            var e = {};
            return function(i) {
                return e.hasOwnProperty(i) || (e[i] = t.apply(null, arguments)), e[i]
            }
        }
        function s(t, e) {
            e || (e = d.getStyle(t));
            for (var i, r = d.quotedList(e.get("fontFamily").toLowerCase()), n = 0, o = r.length; n < o; ++n)
                if (i = r[n], y[i])
                    return y[i].get(e.get("fontStyle"), e.get("fontWeight"));
            return null
        }
        function a(t) {
        ...
        function c(t, e, i, r, n, o) {
            var s = r.separate;
            if ("none" == s)
                return b[r.engine].apply(null, arguments);
            var a,
                h = fabric.document.createDocumentFragment(),
                c = e.split(w[s]),
                l = "words" == s;
            l && p && (/^\s/.test(e) && c.unshift(""), /\s$/.test(e) && c.push(""));
            for (var u = 0, f = c.length; u < f; ++u)
                (a = b[r.engine](t, l ? d.textAlign(c[u], i, u, f) : c[u], i, r, n, o, u < f - 1)) && h.appendChild(a);
            return h
        }
        function l(t, e) {
            for (var i, r, o, a, h = n(t, e).firstChild; h; h = o) {
                ...
                if (r || (r = d.getStyle(t).extend(e)), i || (i = s(t, r)), i)
                    if (a)
                        b[e.engine](i, null, r, e, h, t);
                    else {
                        var l = h.data;
        ...
        var u = function() {
            ...
            f = u.DOM = {
                ready: function() {
                    ...
                    return fabric.document.addEventListener && (fabric.document.addEventListener("DOMContentLoaded", n, !1), fabric.window.addEventListener("pageshow", n, !1)), !fabric.window.opera && fabric.document.readyState && function() {
                        ...
                        try {
                            fabric.document.body.doScroll("left"), n()
                        } catch (t) {
                            setTimeout(arguments.callee, 1)
                        }
                    }(), r(fabric.window, "load", n), function(e) {
            ...
            d = u.CSS = {
                Size: function(t, e) {
                    this.value = parseFloat(t), this.unit = String(t).match(/[a-z%]*$/)[0] || "px", this.convert = function(t) {
                ...
                quotedList: o(function(t) {
                    for (var e, i = [], r = /\s*((["'])([\s\S]*?[^\\])\2|[^,]+)\s*/g; e = r.exec(t);)
                        i.push(e[3] || e[1]);
                    return i
                }),
                ready: function() {
                    ...
                    return f.ready(function() {
                        for (var t, e = 0, o = 0, s = n.length; t = n[o], o < s; ++o)
                            t.disabled || "stylesheet" != t.rel.toLowerCase() || ++e;
                ...
                textAlign: function(t, e, i, r) {
                    return "right" == e.get("textAlign") ? i > 0 && (t = " " + t) : i < r - 1 && (t += " "), t
                },
                textDecoration: function(t, e) {
                    ...
                    for (var i = {
                        ...
                        var n = !0;
                        for (var o in i)
                            i[o] || (-1 != e.get("textDecoration").indexOf(o) && (i[o] = e.get("color")), n = !1);
                        if (n)
                            break;
                ...
                textShadow: o(function(t) {
                    if ("none" == t)
                        return null;
                    for (var e, i = [], r = {}, n = 0, o = /(#[a-f0-9]+|[a-z]+\(.*?\)|[a-z]+)|(-?[\d.]+[a-z%]*)|,/gi; e = o.exec(t);)
                        "," == e[0] ? (i.push(r), r = {}, n = 0) : e[1] ? r.color = e[1] : r[["offX", "offY", "blur"][n++]] = e[2];
                    return i.push(r), i
                }),
                color: o(function(t) {
                    var e = {};
                    return e.color = t.replace(/^rgba\((.*?),\s*([\d.]+)\)/, function(t, i, r) {
                        return e.opacity = parseFloat(r), "rgb(" + i + ")"
                    }), e
                }),
            ...
            x = {
                ...
                printable: !0,
                selector: fabric.window.Sizzle || fabric.window.jQuery && function(t) {
                    return jQuery(t)
                } || fabric.window.dojo && dojo.query || fabric.window.$$ && function(t) {
                    return $$(t)
                } || fabric.window.$ && function(t) {
                    return $(t)
                } || fabric.document.querySelectorAll && function(t) {
        ...
        return u.now = function() {
            ...
            for (var t = v.splice(0, v.length), e = 0, i = t.length; e < i; ++e)
                u.replace.apply(null, t[e]);
            return u
            ...
            var r = new t(i),
                n = r.family;
            return y[n] || (y[n] = new e), y[n].add(r), u.set("fontFamily", '"' + n + '"')
            ...
            return "string" == typeof (e = h(x, e)).textShadow && e.textShadow && (e.textShadow = d.textShadow(e.textShadow)), l(t, e)
        }, u.engines = b, u.fonts = y, u.getOptions = function() {
            return h(x)
        }, u.set = function(t, e) {
            return x[t] = e, u
        }, u
    ...
    Cufon.registerEngine("canvas", function() {
        ...
        try {
            ...
            n.setAttribute("type", "text/css"), n.styleSheet.cssText = o.data
        }
        return fabric.document.getElementsByTagName("head")[0].appendChild(n), function(r, n, o, s, a, h) {
            function c(i) {
                ...
                for (var h = 0, c = _.length; h < c; ++h)
                    if ("\n" !== _[h]) {
                        ...
                        if (l) {
                            ...
                            U && (W.save(), W.strokeStyle = W.fillStyle, W.lineWidth += W.lineWidth, W.beginPath(), U.underline && (W.moveTo(0, .5 - r.face["underline-position"]), W.lineTo(u, .5 - r.face["underline-position"])), U.overline && (W.moveTo(0, r.ascent + .5), W.lineTo(u, r.ascent + .5)), U["line-through"] && (W.moveTo(0, .5 - r.descent), W.lineTo(u, .5 - r.descent)), W.stroke(), W.restore()), q && (W.save(), W.transform(1, 0, -.25, 1, 0, 0)), W.beginPath(), l.d && (l.code ? e(l.code, W) : l.code = t("m" + l.d, W)), W.fill(), s.strokeStyle && (W.closePath(), W.save(), W.lineWidth = s.strokeWidth, W.strokeStyle = s.strokeStyle, W.stroke(), W.restore()), q && W.restore(), W.translate(u, 0), n += u
                        }
                    } else {
                        a++;
                        var f = -r.ascent - r.ascent / 5 * s.lineHeight;
                        "right" === s.textAlign ? (W.translate(-T, f), W.translate(I[a], 0)) : "center" === s.textAlign ? (W.translate(-n - I[a - 1] / 2, f), W.translate(I[a] / 2, 0)) : W.translate(-n, f), n = 0
                    }
            }
            var l = null === n,
                u = r.viewBox,
            ...
            for (var _ = Cufon.CSS.textTransform(l ? a.alt : n, o).split(""), T = 0, O = null, k = 0, E = 1, A = [], y = 0, x = _.length; y < x; ++y)
                if ("\n" !== _[y]) {
                    var j = r.glyphs[_[y]] || r.missingGlyph;
                    j && (T += O = Number(j.w || r.w) + d)
                } else
                    E++, T > k && (k = T), A.push(T), T = 0;
            A.push(T), T = Math.max(k, T);
            for (var I = [], y = A.length; y--;)
                I[y] = T - A[y];
            if (null === O)
                return null;
            g += u.width - O, m += u.minX;
            var P,
                M;
            if (l)
                P = a, M = a.firstChild;
                ...
                D.className = "cufon-alt", D.appendChild(fabric.document.createTextNode(n)), P.appendChild(D)
            }
            var L = P.style,
                R = M.style || {},
                ...
                F = Math.ceil(B),
                N = F / B;
            M.width = Math.ceil(f.convert(T + g - m) * N), M.height = F, p += u.minY, R.top = Math.round(f.convert(p - r.ascent)) + "px", R.left = Math.round(f.convert(m)) + "px";
            var G = Math.ceil(f.convert(T * N)),
                X = G + "px",
                z = f.convert(r.height),
                V = (s.lineHeight - 1) * f.convert(-r.ascent / 5) * (E - 1);
            Cufon.textOptions.width = G, Cufon.textOptions.height = z * E + V, Cufon.textOptions.lines = E, Cufon.textOptions.totalLineHeight = V, i ? (L.width = X, L.height = z + "px") : (L.paddingLeft = X, L.paddingBottom = z - 1 + "px");
            var W = Cufon.textOptions.context || M.getContext("2d"),
                Y = F / u.height;
            Cufon.textOptions.fontAscent = r.ascent * Y, Cufon.textOptions.boundaries = null;
            for (var H = Cufon.textOptions.shadowOffsets, y = b.length; y--;)
                H[y] = [b[y][0] * Y, b[y][1] * Y];
            W.save(), W.scale(Y, Y), W.translate(-m - 1 / Y * M.width / 2 + (Cufon.fonts[r.family].offsetLeft || 0), -p - Cufon.textOptions.height / Y / 2 + (Cufon.fonts[r.family].offsetTop || 0)), W.lineWidth = r.face["underline-thickness"], W.save();
            ...
            if (W.save(), function() {
                ...
                s.backgroundColor && (W.save(), W.fillStyle = s.backgroundColor, W.translate(0, r.ascent), W.fillRect(0, 0, T + 10, (-r.ascent + r.descent) * E), W.restore()), "right" === s.textAlign ? (W.translate(I[e], 0), i[0].left = I[e] * Y) : "center" === s.textAlign && (W.translate(I[e] / 2, 0), i[0].left = I[e] / 2 * Y);
                for (var n = 0, o = _.length; n < o; ++n)
                    if ("\n" !== _[n]) {
                        var a = r.glyphs[_[n]] || r.missingGlyph;
                        if (a) {
                            var h = Number(a.w || r.w) + d;
                            s.textBackgroundColor && (W.save(), W.fillStyle = s.textBackgroundColor, W.translate(0, r.ascent), W.fillRect(0, 0, h + 10, -r.ascent + r.descent), W.restore()), W.translate(h, 0), t += h, n == o - 1 && (i[i.length - 1].width = t * Y, i[i.length - 1].height = (-r.ascent + r.descent) * Y)
                        }
                    } else {
                        e++;
                        ...
                        l.width = t * Y, l.height = (-r.ascent + r.descent) * Y, "right" === s.textAlign ? (W.translate(-T, c), W.translate(I[e], 0), u.left = I[e] * Y) : "center" === s.textAlign ? (W.translate(-t - I[e - 1] / 2, c), W.translate(I[e] / 2, 0), u.left = I[e] / 2 * Y) : W.translate(-t, c), i.push(u), t = 0
                    }
                W.restore(), Cufon.textOptions.boundaries = i
            }(), v)
                for (var y = 0, x = v.length; y < x; ++y) {
                    w = v[y];
                    W.save(), W.translate.apply(W, b[y]), c(w.color), W.restore()
                }
            return c(), W.restore(), W.restore(), W.restore(), P
        }
        ...
        function e(t, e) {
            ...
            t.runtimeStyle.left = t.currentStyle.left, t.style.left = e;
            var n = t.style.pixelLeft;
            return t.style.left = i, t.runtimeStyle.left = r, n
        }
                    ...
                    return r = null, fabric.document.write('<style type="text/css">.cufon-vml-canvas{text-indent:0}@media screen{cvml\\:shape,cvml\\:shadow{behavior:url(#default#VML);display:block;antialias:true;position:absolute}.cufon-vml-canvas{position:absolute;text-align:left}.cufon-vml{display:inline-block;position:relative;vertical-align:middle}.cufon-vml .cufon-alt{position:absolute;left:-10000in;font-size:1px}a .cufon-vml{cursor:pointer}}@media print{.cufon-vml *{display:none}.cufon-vml .cufon-alt{display:inline}}</style>'), function(i, r, n, o, s, a, h) {
                        ...
                        if (c)
                            ...
                            if (d = fabric.document.createElement("span"), d.className = "cufon cufon-vml", d.alt = r, p = fabric.document.createElement("span"), p.className = "cufon-vml-canvas", d.appendChild(p), o.printable) {
                                ...
                                g.className = "cufon-alt", g.appendChild(fabric.document.createTextNode(r)), d.appendChild(g)
                            }
                        ...
                        var m = d.style,
                            ...
                            w = l.minX,
                            S = l.minY;
                        v.height = y, v.top = Math.round(u.convert(S - i.ascent)), v.left = Math.round(u.convert(w)), m.height = u.convert(i.height) + "px";
                        Cufon.getTextDecoration(o);
                        for (var C, _, T = n.get("color"), O = Cufon.CSS.textTransform(r, n).split(""), k = 0, E = 0, A = null, j = o.textShadow, I = 0, P = 0, M = O.length; I < M; ++I)
                            (C = i.glyphs[O[I]] || i.missingGlyph) && (k += A = ~~(C.w || i.w) + f);
                        if (null === A)
                            return null;
                        var D,
                            L = -w + k + (l.width - A),
                            ...
                            N = "r" + F + "nsnf";
                        for (I = 0; I < M; ++I)
                            if (C = i.glyphs[O[I]] || i.missingGlyph) {
                                c ? (_ = p.childNodes[P]).firstChild && _.removeChild(_.firstChild) : (_ = fabric.document.createElement("cvml:shape"), p.appendChild(_)), _.stroked = "f", _.coordsize = F, _.coordorigin = D = w - E + "," + S, _.path = (C.d ? "m" + C.d + "xe" : "") + "m" + D + N, _.fillcolor = T;
                                var G = _.style;
                                if (G.width = B, G.height = y, j) {
                                    ...
                                    Y.on = "t", Y.color = W.color, Y.offset = z.offX + "," + z.offY, V && (X = Cufon.CSS.color(V.color), Y.type = "double", Y.color2 = X.color, Y.offset2 = V.offX + "," + V.offY), Y.opacity = W.opacity || X && X.opacity || 1, _.appendChild(Y)
                                }
                                E += ~~(C.w || i.w) + f, ++P
                            }
                        return m.width = Math.max(Math.ceil(u.convert(k * x)), 0), d
                    }
            }
        }
    ...
    }, void 0 !== exports && (exports.Cufon = Cufon), "object" != typeof JSON && (JSON = {}), function() {
        "use strict";
        function f(t) {
            return t < 10 ? "0" + t : t
        }
        ...
        function str(t, e) {
            ...
            case "object":
                ...
                if (gap += indent, s = [], "[object Array]" === Object.prototype.toString.apply(h)) {
                    for (o = h.length, i = 0; i < o; i += 1)
                        s[i] = str(i, h) || "null";
                    return n = 0 === s.length ? "[]" : gap ? "[\n" + gap + s.join(",\n" + gap) + "\n" + a + "]" : "[" + s.join(",") + "]", gap = a, n
                }
                if (rep && "object" == typeof rep)
                    for (o = rep.length, i = 0; i < o; i += 1)
                        "string" == typeof rep[i] && (n = str(r = rep[i], h)) && s.push(quote(r) + (gap ? ": " : ":") + n);
                else
                    for (r in h)
                        Object.prototype.hasOwnProperty.call(h, r) && (n = str(r, h)) && s.push(quote(r) + (gap ? ": " : ":") + n);
                return n = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, n
            }
        }
        ...
        remove: function() {
            for (var t, e = this.getObjects(), i = 0, r = arguments.length; i < r; i++)
                -1 !== (t = e.indexOf(arguments[i])) && (e.splice(t, 1), this._onObjectRemoved(arguments[i]));
            return this.renderOnAddRemove && this.renderAll(), this
        },
        ...
        fabric.util = {
            ...
            resolveNamespace: function(e) {
                if (!e)
                    return fabric;
                for (var i = e.split("."), r = i.length, n = t || fabric.window, o = 0; o < r; ++o)
                    n = n[i[o]];
                return n
            },
            loadImage: function(t, e, i, r) {
                if (t) {
                    ...
                    }, 0 !== t.indexOf("data") && void 0 !== r && (n.crossOrigin = r), n.src = t
                } else
                    e && e.call(i, t)
            },
            ...
            drawDashedLine: function(t, r, n, o, s, a) {
                ...
                for (t.save(), t.translate(r, n), t.moveTo(0, 0), t.rotate(u), r = 0; l > r;)
                    (r += a[d++ % f]) > l && (r = l), t[p ? "lineTo" : "moveTo"](r, 0), p = !p;
                t.restore()
            },
            ...
            isTransparent: function(t, e, i, r) {
                ...
                for (var n = !0, o = t.getImageData(e, i, 2 * r || 1, 2 * r || 1), s = 3, a = o.data.length; s < a && !1 != (n = o.data[s] <= 0); s += 4)
                    ;
                return o = null, n
            }
        }
    }(void 0 !== exports ? exports : this), function() {
        function t(t, n, s, a, h, c, l) {
            ...
            for (var M = Math.ceil(Math.abs(P / (.5 * f))), D = [], L = P / M, R = 8 / 3 * Math.sin(L / 4) * Math.sin(L / 4) / Math.sin(L / 2), B = I + L, F = 0; F < M; F++)
                D[F] = e(I, B, g, p, s, a, A, j, R, m, v), m = D[F][4], v = D[F][5], I += L, B += L;
            return r[u] = D, D
        }
        ...
        fabric.util.drawArc = function(e, i, r, n) {
            for (var o = n[0], s = n[1], a = n[2], h = n[3], c = n[4], l = [[], [], [], []], u = t(n[5] - i, n[6] - r, o, s, h, c, a), f = 0, d = u.length; f < d; f++)
                l[f][0] = u[f][0] + i, l[f][1] = u[f][1] + r, l[f][2] = u[f][2] + i, l[f][3] = u[f][3] + r, l[f][4] = u[f][4] + i, l[f][5] = u[f][5] + r, e.bezierCurveTo.apply(e, l[f])
        }
    }(), function() {
        function t(t, e, i) {
            if (t && 0 !== t.length) {
        ...
        fabric.util.array = {
            invoke: function(t, i) {
                for (var r = e.call(arguments, 2), n = [], o = 0, s = t.length; o < s; o++)
                    n[o] = r.length ? t[o][i].apply(t[o], r) : t[o][i].call(t[o]);
                return n
            },
            min: function(e, i) {
        ...
        fabric.util.createClass = function() {
            ...
            "function" == typeof a[0] && (s = a.shift()), n.superclass = s, n.subclasses = [], s && (t.prototype = s.prototype, n.prototype = new t, s.subclasses.push(n));
        ...
        function r(t, e) {
            return function(i) {
                if (p[t] && p[t][e])
                    for (var r = p[t][e], n = 0, o = r.length; n < o; n++)
        ...
        var c,
            l,
            u = t(fabric.document.documentElement, "addEventListener", "removeEventListener") && t(fabric.window, "addEventListener", "removeEventListener"),
        ...
        u ? (c = function(t, e, i) {
            ...
            var n = h(t);
            s(n, t), d[n] || (d[n] = {}), d[n][i] || (d[n][i] = []);
            var o = e(n, r);
            d[n][i].push(o), t.attachEvent("on" + i, o.wrappedHandler)
        }, l = function(t, e, i) {
            var r,
                n = h(t);
            if (d[n] && d[n][e])
                for (var o = 0, s = d[n][e].length; o < s; o++)
                    (r = d[n][e][o]) && r.handler === i && (t.detachEvent("on" + e, r.wrappedHandler), d[n][e][o] = null)
        }) : (c = function(t, e, i) {
            var n = h(t);
            if (p[n] || (p[n] = {}), !p[n][e]) {
                p[n][e] = [];
                var o = t["on" + e];
                o && p[n][e].push(o), t["on" + e] = r(n, e)
            }
            p[n][e].push(i)
        }, l = function(t, e, i) {
            var r = h(t);
            if (p[r] && p[r][e])
                for (var n = p[r][e], o = 0, s = n.length; o < s; o++)
                    n[o] === i && n.splice(o, 1)
        ...
        e ? n = function(t, e) {
            ...
            if (!i)
                return t;
            if ("string" == typeof e)
                return t.style.cssText += ";" + e, e.indexOf("opacity") > -1 ? n(t, e.match(/opacity:\s*(\d?\.?\d*)/)[1]) : t;
            for (var r in e)
        ...
        n = fabric.document.defaultView && fabric.document.defaultView.getComputedStyle ? function(t, e) {
        ...
        }, fabric.util.toArray = r, fabric.util.makeElement = t, fabric.util.addClass = function(t, e) {
            ...
            for (r = t; t && t.parentNode && !i;)
                (t = t.parentNode) !== fabric.document && "fixed" === fabric.util.getElementStyle(t, "position") && (i = t), t !== fabric.document && r !== e && "absolute" === fabric.util.getElementStyle(t, "position") ? (n = 0, o = 0) : t === fabric.document ? (n = a.scrollLeft || s.scrollLeft || 0, o = a.scrollTop || s.scrollTop || 0) : (n += t.scrollLeft || 0, o += t.scrollTop || 0);
            return {
                left: n,
                top: o
            }
            ...
            for (var h in a)
                s[a[h]] += parseInt(n(t, h), 10) || 0;
            return e = r.documentElement, void 0 !== t.getBoundingClientRect && (o = t.getBoundingClientRect()), i = fabric.util.getScrollLeftTop(t, null), {
        ...
        fabric.util.request = function(r, n) {
            n || (n = {});
            var o,
                s = n.method ? n.method.toUpperCase() : "GET",
                a = n.onComplete || function() {},
                h = i();
            return h.onreadystatechange = function() {
                4 === h.readyState && (a(h), h.onreadystatechange = e)
            }, "GET" === s && (o = null, "string" == typeof n.parameters && (r = t(r, n.parameters))), h.open(s, r, !0), "POST" !== s && "PUT" !== s || h.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), h.send(o), h
        }
        ...
        function i(t, e, i) {
            ...
            return "fill" !== t && "stroke" !== t || "none" !== e ? "fillRule" === t ? e = "evenodd" === e ? "destination-over" : e : "strokeDashArray" === t ? e = e.replace(/,/g, " ").split(/\s+/).map(function(t) {
                return parseInt(t)
            }) : "transformMatrix" === t ? e = i && i.transformMatrix ? w(i.transformMatrix, g.parseTransformAttribute(e)) : g.parseTransformAttribute(e) : "visible" === t ? (e = "none" !== e && "hidden" !== e, i && !1 === i.visible && (e = !1)) : "originX" === t ? e = "start" === e ? "left" : "end" === e ? "right" : "center" : r = n ? e.map(x) : x(e) : e = "", !n && isNaN(r) ? e : r
        }
        function r(t) {
            for (var e in C)
                if (t[e] && void 0 !== t[C[e]] && 0 !== t[e].indexOf("url(")) {
        ...
        function n(t, e) {
            ...
            if (i) {
                var r = i[1],
                    ...
                    s = i[5],
                    a = i[6];
                r && (e.fontStyle = r), n && (e.fontWeight = isNaN(parseFloat(n)) ? n : parseFloat(n)), o && (e.fontSize = parseFloat(o)), a && (e.fontFamily = a), s && (e.lineHeight = "normal" === s ? 1 : s)
            }
        }
        function o(t, r) {
            var o,
            ...
            t.replace(/;$/, "").split(";").forEach(function(t) {
                var a = t.split(":");
                o = e(a[0].trim().toLowerCase()), s = i(o, a[1].trim()), "font" === o ? n(s, r) : r[o] = s
            })
        }
        function s(t, r) {
            var o,
                s;
            for (var a in t)
                void 0 !== t[a] && (s = i(o = e(a.toLowerCase()), t[a]), "font" === o ? n(s, r) : r[o] = s)
        }
        function a(t) {
            var e = {};
            for (var i in g.cssRules)
                if (h(t, i.split(" ")))
                    for (var r in g.cssRules[i])
                        e[r] = g.cssRules[i][r];
            return e
        }
        function h(t, e) {
        ...
        function l(t, e) {
            var i,
                ...
                o = t.getAttribute("id");
            if (i = new RegExp("^" + r, "i"), e = e.replace(i, ""), o && e.length && (i = new RegExp("#" + o + "(?![a-zA-Z\\-]+)", "i"), e = e.replace(i, "")), n && e.length)
                for (var s = (n = n.split(" ")).length; s--;)
                    i = new RegExp("\\." + n[s] + "(?![a-zA-Z\\-]+)", "i"), e = e.replace(i, "");
            return 0 === e.length
        }
        function u(t) {
            for (var e = t.getElementsByTagName("use"); e.length;) {
                ...
                s.setAttribute("transform", a), s.removeAttribute("id"), i.parentNode.replaceChild(s, i)
            }
        }
        function f(t, e) {
            if (e[3] = e[0] = e[0] > e[3] ? e[3] : e[0], 1 !== e[0] || 1 !== e[3] || 0 !== e[4] || 0 !== e[5]) {
                for (var i = t.ownerDocument.createElement("g"); null != t.firstChild;)
                    i.appendChild(t.firstChild);
                i.setAttribute("transform", "matrix(" + e[0] + " " + e[1] + " " + e[2] + " " + e[3] + " " + e[4] + " " + e[5] + ")"), t.appendChild(i)
            }
        }
        function d(t) {
            var e = t.objects,
            ...
            return function(s) {
                ...
                s.replace(l, function(s) {
                    ...
                    case "translate":
                        ...
                        break;
                    case "rotate":
                        f[0] = g.util.degreesToRadians(f[0]), t(a, f);
                        break;
                    case "scale":
                        e(a, f);
                        break;
                    ...
                    u.push(a.concat()), a = o.concat()
                });
                for (var f = u[0]; u.length > 1;)
                    u.shift(), f = g.util.multiplyTransformMatrices(f, u[0]);
                return f
            }
        }(), g.parseSVGDocument = function() {
            function t(t, e) {
                for (; t && (t = t.parentNode);)
                    if (e.test(t.nodeName))
                        return !0;
                return !1
            }
                ...
                if (i) {
                    ...
                    if (c && (c = c.match(r))) {
                        var p = parseFloat(c[1]),
                            ...
                            v = 1,
                            y = 1;
                        a = parseFloat(c[3]), h = parseFloat(c[4]), l && l !== a && (v = l / a), d && d !== h && (y = d / h), f(i, [v, 0, 0, y, v * -p, y * -m])
                    }
                    var w = g.util.toArray(i.getElementsByTagName("*"));
                    if (0 === w.length && g.isLikelyNode) {
                        for (var S = [], C = 0, _ = (w = i.selectNodes('//*[name(.)!="svg"]')).length; C < _; C++)
                            S[C] = w[C];
                        w = S
                    }
                    ...
                    if (!T || T && !T.length)
                        ...
                        g.gradientDefs = g.getGradientDefs(i), g.cssRules = g.getCSSRules(i), g.parseElements(T, function(t) {
                            g.documentParsingTime = new Date - s, n && n(t, O)
                        }, b(O), o)
                    }
                }
            }
        ...
        m(g, {
            getGradientDefs: function(t) {
                var e,
                    ...
                    r,
                    n,
                    o = t.getElementsByTagName("linearGradient"),
                    s = t.getElementsByTagName("radialGradient"),
                    a = 0,
                    h = [],
                    c = {},
                    l = {};
                for (h.length = o.length + s.length, i = o.length; i--;)
                    h[a++] = o[i];
                for (i = s.length; i--;)
                    h[a++] = s[i];
                for (; a--;)
                    n = (e = h[a]).getAttribute("xlink:href"), r = e.getAttribute("id"), n && (l[r] = n.substr(1)), c[r] = e;
                for (r in l) {
                    var u = c[l[r]].cloneNode(!0);
                    for (e = c[r]; u.firstChild;)
            ...
            parseAttributes: function(t, n) {
                if (t) {
                    ...
                    var h = n.reduce(function(r, n) {
                        return (o = t.getAttribute(n)) && (n = e(n), o = i(n, o, s), r[n] = o), r
                    }, {});
                    return h = m(h, m(a(t), g.parseStyleAttribute(t))), r(m(s, h))
                }
            },
            ...
            getCSSRules: function(t) {
                for (var r = t.getElementsByTagName("style"), n = {}, o = 0, s = r.length; o < s; o++) {
                    var a = r[0].textContent;
                    (a = a.replace(/\/\*[\s\S]*?\*\//g, "")).match(/[^{]*\{[\s\S]*?\}/g).map(function(t) {
                        return t.trim()
                    }).forEach(function(t) {
                        for (var r = t.match(/([\s\S]*?)\s*\{([^}]*)\}/), o = {}, s = r[2].trim().replace(/;$/, "").split(/\s*;\s*/), a = 0, h = s.length; a < h; a++) {
                            var c = s[a].split(/\s*:\s*/),
                                l = e(c[0]),
                                u = i(l, c[1], c[0]);
                            o[l] = u
            ...
            loadSVGFromURL: function(t, e, i) {
                function r(r) {
                    var n = r.responseXML;
                    n && !n.documentElement && g.window.ActiveXObject && r.responseText && ((n = new ActiveXObject("Microsoft.XMLDOM")).async = "false", n.loadXML(r.responseText.replace(/<!DOCTYPE[\s\S]*?(\[[\s\S]*\])*?>/i, ""))), n && n.documentElement && g.parseSVGDocument(n.documentElement, function(i, r) {
                        _.set(t, {
                ...
                t = t.replace(/^\n\s*/, "").trim(), _.has(t, function(i) {
                    i ? _.get(t, function(t) {
                        var i = d(t);
            ...
            loadSVGFromString: function(t, e, i) {
                ...
                if ("undefined" != typeof DOMParser) {
                    ...
                    g.window.ActiveXObject && ((r = new ActiveXObject("Microsoft.XMLDOM")).async = "false", r.loadXML(t.replace(/<!DOCTYPE[\s\S]*?(\[[\s\S]*\])*?>/i, "")));
                g.parseSVGDocument(r.documentElement, function(t, i) {
                    e(t, i)
                }, i)
            },
            createSVGFontFacesMarkup: function(t) {
                for (var e = "", i = 0, r = t.length; i < r; i++)
                    "text" === t[i].type && t[i].path && (e += ["@font-face {", "font-family: ", t[i].fontFamily, "; ", "src: url('", t[i].path, "')", "}"].join(""));
    ...
    }(void 0 !== exports ? exports : this), fabric.ElementsParser = function(t, e, i, r) {
        this.elements = t, this.callback = e, this.options = i, this.reviver = r
    ...
    }(void 0 !== exports ? exports : this), function(t) {
        "use strict";
        function e(t) {
        ...
        i.Intersection ? i.warn("fabric.Intersection is already defined") : (i.Intersection = e, i.Intersection.prototype = {
            ...
            if (0 !== c) {
                ...
                s = new e(0 === a || 0 === h ? "Coincident" : "Parallel");
            return s
        }, i.Intersection.intersectLinePolygon = function(t, i, r) {
            for (var n = new e, o = r.length, s = 0; s < o; s++) {
                var a = r[s],
                    h = r[(s + 1) % o],
            ...
            for (var r = new e, n = t.length, o = 0; o < n; o++) {
                var s = t[o],
                    a = t[(o + 1) % n],
        ...
        r.Color ? r.warn("fabric.Color is already defined.") : (r.Color = e, r.Color.prototype = {
            _tryParsingColor: function(t) {
                var i;
                t in e.colorNameMap && (t = e.colorNameMap[t]), "transparent" !== t ? ((i = e.sourceFromHex(t)) || (i = e.sourceFromRgb(t)), i || (i = e.sourceFromHsl(t)), i && this.setSource(i)) : this.setSource([255, 255, 255, 0])
            },
            ...
            overlayWith: function(t) {
                ...
                for (var i = [], r = this.getAlpha(), n = this.getSource(), o = t.getSource(), s = 0; s < 3; s++)
                    i.push(Math.round(.5 * n[s] + .5 * o[s]));
            ...
            if (r) {
                ...
                if (0 === h)
                    ...
                    var l = c <= .5 ? c * (h + 1) : c + h - c * h,
                        u = 2 * c - l;
                    n = i(u, l, a + 1 / 3), o = i(u, l, a), s = i(u, l, a - 1 / 3)
                }
        ...
        function r(t, e, i) {
            var r,
                ...
                s = "";
            for (var a in e)
                r = parseFloat(e[a], 10), o = "string" == typeof e[a] && /^\d+%$/.test(e[a]) ? .01 : 1, "x1" === a || "x2" === a || "r2" === a ? (o *= "objectBoundingBox" === i ? t.width : 1, n = "objectBoundingBox" === i ? t.left || 0 : 0) : "y1" !== a && "y2" !== a || (o *= "objectBoundingBox" === i ? t.height : 1, n = "objectBoundingBox" === i ? t.top || 0 : 0), e[a] = r * o + n;
        ...
        fabric.Gradient = fabric.util.createClass({
            ...
            toSVG: function(t) {
                ...
                for (var o = 0; o < this.colorStops.length; o++)
                    e.push("<stop ", 'offset="', 100 * this.colorStops[o].offset + "%", '" style="stop-color:', this.colorStops[o].color, null != this.colorStops[o].opacity ? ";stop-opacity: " + this.colorStops[o].opacity : ";", '"/>\n');
            ...
            toLive: function(t) {
                ...
                if (this.type) {
                    ...
                    for (var i = 0, r = this.colorStops.length; i < r; i++) {
                        var n = this.colorStops[i].color,
                            o = this.colorStops[i].opacity,
                            s = this.colorStops[i].offset;
                        void 0 !== o && (n = new fabric.Color(n).setAlpha(o).toRgba()), e.addColorStop(parseFloat(s), n)
                    }
                    return e
                }
            }
            ...
            fromElement: function(n, o) {
                ...
                return (l || "" !== s) && (p.gradientTransform = fabric.parseTransformAttribute((l || "") + s)), p
            },
        ...
        initialize: function(t) {
            if (t || (t = {}), this.id = fabric.Object.__uid++, t.source)
                if ("string" == typeof t.source)
                    if (void 0 !== fabric.util.getFunctionBody(t.source))
        ...
        toSVG: function(t) {
            var e = "function" == typeof this.source ? this.source() : this.source,
                ...
                n = "";
            return e.src ? n = e.src : e.toDataURL && (n = e.toDataURL()), '<pattern id="SVGID_' + this.id + '" x="' + this.offsetX + '" y="' + this.offsetY + '" width="' + i + '" height="' + r + '"><image x="0" y="0" width="' + e.width + '" height="' + e.height + '" xlink:href="' + n + '"></image></pattern>'
        },
        toLive: function(t) {
            var e = "function" == typeof this.source ? this.source() : this.source;
            if (!e)
        ...
        e.Shadow ? e.warn("fabric.Shadow is already defined.") : (e.Shadow = e.util.createClass({
            ...
            toSVG: function(t) {
                var e = "SourceAlpha";
                return !t || t.fill !== this.color && t.stroke !== this.color || (e = "SourceGraphic"), '<filter id="SVGID_' + this.id + '" y="-40%" height="180%"><feGaussianBlur in="' + e + '" stdDeviation="' + (this.blur ? this.blur / 3 : 0) + '"></feGaussianBlur><feOffset dx="' + this.offsetX + '" dy="' + this.offsetY + '"></feOffset><feMerge><feMergeNode></feMergeNode><feMergeNode in="SourceGraphic"></feMergeNode></feMerge></filter>'
            },
            toObject: function() {
        ...
        if (fabric.StaticCanvas)
            ...
            fabric.StaticCanvas = fabric.util.createClass({
                ...
                _initCanvasElement: function(t) {
                    if (fabric.util.createCanvasElement(t), void 0 === t.getContext)
                        throw r
                },
                ...
                setDimensions: function(t, e) {
                    ...
                    e = e || {};
                    for (var r in t)
                        i = t[r], e.cssOnly || (this._setBackstoreDimension(r, t[r]), i += "px"), e.backstoreOnly || this._setCssDimension(r, i);
                ...
                _draw: function(t, e) {
                    if (e) {
                        ...
                        t.transform(i[0], i[1], i[2], i[3], i[4], i[5]), e.render(t), t.restore(), this.controlsAboveOverlay || e._renderControls(t)
                    }
                },
                ...
                _renderObjects: function(t, e) {
                    var i,
                        r;
                    if (e)
                        for (i = 0, r = this._objects.length; i < r; ++i)
                            this._objects[i] && !e.contains(this._objects[i]) && this._draw(t, this._objects[i]);
                    else
                        for (i = 0, r = this._objects.length; i < r; ++i)
                            this._draw(t, this._objects[i])
                },
                ...
                _toObjectMethod: function(e, i) {
                    ...
                    return t(n, this.__serializeBgOverlay()), fabric.util.populateWithProperties(this, n, i), r && (this.setActiveGroup(new fabric.Group(r.getObjects(), {
                        originX: "center",
                        originY: "center"
                    })), r.forEachObject(function(t) {
                        t.set("active", !0)
                    }), this._currentTransform && (this._currentTransform.target = this.getActiveGroup())), n
                },
                ...
                _setSVGHeader: function(t, e) {
                    var i,
                        r,
                        n;
                    e.viewBox ? (i = e.viewBox.width, r = e.viewBox.height) : (i = this.width, r = this.height, this.svgViewportTransformation || (i /= (n = this.viewportTransform)[0], r /= n[3])), t.push("<svg ", 'xmlns="http://www.w3.org/2000/svg" ', 'xmlns:xlink="http://www.w3.org/1999/xlink" ', 'version="1.1" ', 'width="', i, '" ', 'height="', r, '" ', this.backgroundColor && !this.backgroundColor.toLive ? 'style="background-color: ' + this.backgroundColor + '" ' : null, e.viewBox ? 'viewBox="' + e.viewBox.x + " " + e.viewBox.y + " " + e.viewBox.width + " " + e.viewBox.height + '" ' : null, 'xml:space="preserve">', "<desc>Created with Fabric.js ", fabric.version, "</desc>", "<defs>", fabric.createSVGFontFacesMarkup(this.getObjects()), fabric.createSVGRefElementsMarkup(this), "</defs>")
                },
                _setSVGObjects: function(t, e) {
                    var i = this.getActiveGroup();
                    i && this.discardActiveGroup();
                    for (var r = 0, n = this.getObjects(), o = n.length; r < o; r++)
                        t.push(n[r].toSVG(e));
        ...
        fabric.PencilBrush = fabric.util.createClass(fabric.BaseBrush, {
            ...
            _render: function() {
                ...
                for (var n = 1, o = this._points.length; n < o; n++) {
                    ...
                    t.quadraticCurveTo(i.x, i.y, s.x, s.y), i = this._points[n], r = this._points[n + 1]
                }
            ...
            getPathBoundingBox: function(i) {
                for (var r = [], n = [], o = i[0], s = i[1], a = o, h = 1, c = i.length; h < c; h++) {
                    ...
                    r.push(a.x), r.push(l.x), n.push(a.y), n.push(l.y), o = i[h], s = i[h + 1], a = l
                }
                return r.push(o.x), n.push(o.y), {
                    minX: t(r),
                    minY: t(n),
                    maxX: e(r),
                    maxY: e(n)
            ...
            convertPointsToSVGPath: function(t, e, i) {
                ...
                for (var s = 1, a = t.length; s < a; s++) {
                    var h = n.midPointFrom(o);
                    r.push("Q ", n.x, " ", n.y, " ", h.x, " ", h.y, " "), n = new fabric.Point(t[s].x - e, t[s].y - i), s + 1 < t.length && (o = new fabric.Point(t[s + 1].x - e, t[s + 1].y - i))
                }
                return r.push("L ", n.x, " ", n.y, " "), r
            },
            createPath: function(t) {
                var e = new fabric.Path(t);
                return e.fill = null, e.stroke = this.color, e.strokeWidth = this.width, e.strokeLineCap = this.strokeLineCap, e.strokeLineJoin = this.strokeLineJoin, this.shadow && (this.shadow.affectStroke = !0, e.setShadow(this.shadow)), e
            },
            _finalizeAndAddPath: function() {
                ...
                if ("M 0 0 Q 0 0 0 0 L 0 0" !== t) {
                    ...
                    r.set({
                        ...
                        originX: "center",
                        originY: "center"
                    }), this.canvas.add(r), r.setCoords(), this.canvas.clearContext(this.canvas.contextTop), this._resetShadow(), this.canvas.renderAll(), this.canvas.fire("path:created", {
                        path: r
                    })
                } else
        ...
        addSprayChunk: function(t) {
            ...
            for (var e, i, r, n = this.width / 2, o = 0; o < this.density; o++) {
        ...
        __toDataURL: function(t, e, i) {
            ...
            return this.contextTop && this.clearContext(this.contextTop), this.renderAll(), n && (n = null), o
        },
        __getCroppedCanvas: function(t, e) {
            var i,
                r;
            return ("left" in e || "top" in e || "width" in e || "height" in e) && (r = (i = fabric.util.createCanvasElement()).getContext("2d"), i.width = e.width || this.width, i.height = e.height || this.height, r.drawImage(t, -e.left || 0, -e.top || 0)), i
        },
        __toDataURLWithMultiplier: function(t, e, i, r) {
            ...
            r > 1 && this.setWidth(s).setHeight(a), l.scale(r, r), i.left && (i.left *= r), i.top && (i.top *= r), i.width ? i.width *= r : r < 1 && (i.width = s), i.height ? i.height *= r : r < 1 && (i.height = a), c ? this._tempRemoveBordersControlsFromGroup(c) : h && this.deactivateAll && this.deactivateAll(), this.renderAll(!0);
            var u = this.__toDataURL(t, e, i);
            return this.width = n, this.height = o, l.scale(1 / r, 1 / r), this.setWidth(n).setHeight(o), c ? this._restoreBordersControlsOnGroup(c) : h && this.setActiveObject && this.setActiveObject(h), this.contextTop && this.clearContext(this.contextTop), this.renderAll(), u
        },
        ...
        e.Object || (e.Object = e.util.createClass({
            ...
            transform: function(t, e) {
                this.group && this.group.transform(t, e), t.globalAlpha = this.opacity;
            ...
            _set: function(t, i) {
                return ("scaleX" === t || "scaleY" === t) && (i = this._constrainScale(i)), "scaleX" === t && i < 0 ? (this.flipX = !this.flipX, i *= -1) : "scaleY" === t && i < 0 ? (this.flipY = !this.flipY, i *= -1) : "width" === t || "height" === t ? this.minScaleLimit = r(Math.min(.1, 1 / Math.max(this.width, this.height)), 2) : "shadow" !== t || !i || i instanceof e.Shadow || (i = new e.Shadow(i)), this[t] = i, this
            },
            toggle: function(t) {
                var e = this.get(t);
            ...
            render: function(t, i) {
                if (0 !== this.width && 0 !== this.height && this.visible) {
                    ...
                    t.globalAlpha = this.group ? t.globalAlpha * this.opacity : this.opacity, this._setShadow(t), this.clipTo && e.util.clipContext(this, t), this._render(t, i), this.clipTo && t.restore(), this._removeShadow(t), this._restoreFillRule(t), t.restore()
                }
            },
            _transform: function(t, e) {
                var i = this.transformMatrix;
                i && !this.group && t.setTransform.apply(t, i), e || this.transform(t)
            },
            ...
            _renderControls: function(t, i) {
                ...
                if (t.save(), this.active && !i) {
                    var n;
                    this.group && (n = e.util.transformPoint(this.group.getCenterPoint(), r), t.translate(n.x, n.y), t.rotate(o(this.group.angle))), n = e.util.transformPoint(this.getCenterPoint(), r, null != this.group), this.group && (n.x *= this.group.scaleX, n.y *= this.group.scaleY), t.translate(n.x, n.y), t.rotate(o(this.angle)), this.drawBorders(t), this.drawControls(t)
                }
                t.restore()
            },
            ...
            _renderFill: function(t) {
                if (this.fill) {
                    ...
                    "destination-over" === this.fillRule ? t.fill("evenodd") : t.fill(), t.restore(), this.shadow && !this.shadow.affectStroke && this._removeShadow(t)
                }
            },
            _renderStroke: function(t) {
                if (this.stroke && 0 !== this.strokeWidth) {
                    if (t.save(), this.strokeDashArray)
                        1 & this.strokeDashArray.length && this.strokeDashArray.push.apply(this.strokeDashArray, this.strokeDashArray), s ? (t.setLineDash(this.strokeDashArray), this._stroke && this._stroke(t)) : this._renderDashedStroke && this._renderDashedStroke(t), t.stroke();
                    else {
            ...
            toDataURL: function(t) {
                ...
                n.add(this);
                var a = n.toDataURL(t);
                return this.set(o).setCoords(), this.canvas = s, n.dispose(), n = null, a
            },
            isType: function(t) {
                return this.type === t
            },
        ...
        fabric.util.object.extend(fabric.Object.prototype, {
            translateToCenterPoint: function(e, i, r) {
                ...
                return "left" === i ? n = e.x + (this.getWidth() + s * this.scaleX) / 2 : "right" === i && (n = e.x - (this.getWidth() + s * this.scaleX) / 2), "top" === r ? o = e.y + (this.getHeight() + s * this.scaleY) / 2 : "bottom" === r && (o = e.y - (this.getHeight() + s * this.scaleY) / 2), fabric.util.rotatePoint(new fabric.Point(n, o), e, t(this.angle))
            },
            ...
            toLocalPoint: function(e, i, r) {
                ...
                return i && r ? (n = "left" === i ? s.x - (this.getWidth() + a * this.scaleX) / 2 : "right" === i ? s.x + (this.getWidth() + a * this.scaleX) / 2 : s.x, o = "top" === r ? s.y - (this.getHeight() + a * this.scaleY) / 2 : "bottom" === r ? s.y + (this.getHeight() + a * this.scaleY) / 2 : s.y) : (n = this.left, o = this.top), fabric.util.rotatePoint(new fabric.Point(e.x, e.y), s, -t(this.angle)).subtractEquals(new fabric.Point(n, o))
            },
            ...
            adjustPosition: function(e) {
                var i = t(this.angle),
                    ...
                    a = Math.cos(i) * s,
                    h = Math.sin(i) * s;
                "center" === this.originX && "left" === e || "right" === this.originX && "center" === e ? (this.left -= n, this.top -= o) : "left" === this.originX && "center" === e || "center" === this.originX && "right" === e ? (this.left += n, this.top += o) : "left" === this.originX && "right" === e ? (this.left += a, this.top += h) : "right" === this.originX && "left" === e && (this.left -= a, this.top -= h), this.setCoords(), this.originX = e
            },
        ...
        fabric.util.object.extend(fabric.Object.prototype, {
            ...
            _findCrossPoints: function(t, e) {
                var i,
                    ...
                    a = 0;
                for (var h in e)
                    if (!((s = e[h]).o.y < t.y && s.d.y < t.y || s.o.y >= t.y && s.d.y >= t.y || (s.o.x === s.d.x && s.o.x >= t.x ? (o = s.o.x, t.y) : (i = 0, r = (s.d.y - s.o.y) / (s.d.x - s.o.x), (n = t.y - i * t.x) + i * (o = -(n - (s.o.y - r * s.o.x)) / (i - r))), o >= t.x && (a += 1), 2 !== a)))
                        break;
                return a
            },
            ...
            scale: function(t) {
                return (t = this._constrainScale(t)) < 0 && (this.flipX = !this.flipX, this.flipY = !this.flipY, t *= -1), this.scaleX = t, this.scaleY = t, this.setCoords(), this
            },
            ...
            setCoords: function() {
                ...
                h ? o = e : c && (s = e), l && (o += e), u && (s += e), this.currentWidth = o * this.scaleX, this.currentHeight = s * this.scaleY, this.currentWidth < 0 && (this.currentWidth = Math.abs(this.currentWidth));
                ...
                return _ = _.add(new fabric.Point(-M, -D)), T = T.add(new fabric.Point(D, -M)), O = O.add(new fabric.Point(M, D)), k = k.add(new fabric.Point(-D, M)), E = E.add(new fabric.Point((-M - D) / 2, (-D + M) / 2)), A = A.add(new fabric.Point((D - M) / 2, -(D + M) / 2)), j = j.add(new fabric.Point((D + M) / 2, (D - M) / 2)), I = I.add(new fabric.Point((M - D) / 2, (M + D) / 2)), P = P.add(new fabric.Point((D - M) / 2, -(D + M) / 2)), this.oCoords = {
                    tl: _,
                    tr: T,
                    br: O,
                    bl: k,
        ...
        i.Line ? i.warn("fabric.Line is already defined") : (i.Line = i.util.createClass(i.Object, {
            ...
            _setWidthHeight: function(t) {
                t || (t = {}), this.width = Math.abs(this.x2 - this.x1) || 1, this.height = Math.abs(this.y2 - this.y1) || 1, this.left = "left" in t ? t.left : this._getLeftToOriginX(), this.top = "top" in t ? t.top : this._getTopToOriginY()
            },
            _set: function(t, e) {
                return this[t] = e, void 0 !== n[t] && this._setWidthHeight(), this
            },
            _getLeftToOriginX: e({
                origin: "originX",
                axis1: "x1",
            ...
            _render: function(t, e) {
                ...
                if (!this.strokeDashArray || this.strokeDashArray && o) {
                    ...
                    t.moveTo(1 === this.width ? 0 : r * this.width / 2, 1 === this.height ? 0 : n * this.height / 2), t.lineTo(1 === this.width ? 0 : -1 * r * this.width / 2, 1 === this.height ? 0 : -1 * n * this.height / 2)
                }
            ...
            _renderDashedStroke: function(t) {
                ...
                t.beginPath(), i.util.drawDashedLine(t, n, o, -n, -o, this.strokeDashArray), t.closePath()
            },
            toObject: function(t) {
            ...
            toSVG: function(t) {
                var e = this._createBaseSVGMarkup(),
                    i = "";
                return this.group || (i = "translate(" + (-this.width / 2 - (this.x1 > this.x2 ? this.x2 : this.x1)) + ", " + (-this.height / 2 - (this.y1 > this.y2 ? this.y2 : this.y1)) + ") "), e.push("<line ", 'x1="', this.x1, '" y1="', this.y1, '" x2="', this.x2, '" y2="', this.y2, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), i, this.getSvgTransformMatrix(), '"/>\n'), t ? t(e.join("")) : e.join("")
            },
            complexity: function() {
                return 1
            }
        ...
        i.Circle ? i.warn("fabric.Circle is already defined.") : (i.Circle = i.util.createClass(i.Object, {
            ...
            toSVG: function(t) {
                var e = this._createBaseSVGMarkup(),
                    i = 0,
                    r = 0;
                return this.group && (i = this.left + this.radius, r = this.top + this.radius), e.push("<circle ", 'cx="' + i + '" cy="' + r + '" ', 'r="', this.radius, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), " ", this.getSvgTransformMatrix(), '"/>\n'), t ? t(e.join("")) : e.join("")
            },
            _render: function(t, e) {
                t.beginPath(), t.arc(e ? this.left + this.radius : 0, e ? this.top + this.radius : 0, this.radius, 0, r, !1), this._renderFill(t), this._renderStroke(t)
            },
            getRadiusX: function() {
        ...
        e.Ellipse ? e.warn("fabric.Ellipse is already defined.") : (e.Ellipse = e.util.createClass(e.Object, {
            ...
            ry: 0,
            initialize: function(t) {
                t = t || {}, this.callSuper("initialize", t), this.set("rx", t.rx || 0), this.set("ry", t.ry || 0), this.set("width", 2 * this.get("rx")), this.set("height", 2 * this.get("ry"))
            },
            toObject: function(t) {
                return r(this.callSuper("toObject", t), {
                    rx: this.get("rx"),
            ...
            toSVG: function(t) {
                var e = this._createBaseSVGMarkup(),
                    i = 0,
                    r = 0;
                return this.group && (i = this.left + this.rx, r = this.top + this.ry), e.push("<ellipse ", 'cx="', i, '" cy="', r, '" ', 'rx="', this.rx, '" ry="', this.ry, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), this.getSvgTransformMatrix(), '"/>\n'), t ? t(e.join("")) : e.join("")
            },
            _render: function(t, e) {
            ...
            r.push("rx", "ry", "x", "y"), e.Rect = e.util.createClass(e.Object, {
                ...
                toSVG: function(t) {
                    var e = this._createBaseSVGMarkup(),
                        i = this.left,
                        r = this.top;
                    return this.group || (i = -this.width / 2, r = -this.height / 2), e.push("<rect ", 'x="', i, '" y="', r, '" rx="', this.get("rx"), '" ry="', this.get("ry"), '" width="', this.width, '" height="', this.height, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), this.getSvgTransformMatrix(), '"/>\n'), t ? t(e.join("")) : e.join("")
                },
                complexity: function() {
                    return 1
                }
                ...
                return n.left = n.left || 0, n.top = n.top || 0, new e.Rect(i(r ? e.util.object.clone(r) : {}, n))
        ...
        e.Polyline ? e.warn("fabric.Polyline is already defined") : (e.Polyline = e.util.createClass(e.Object, {
            ...
            points: null,
            initialize: function(t, e) {
                e = e || {}, this.set("points", t), this.callSuper("initialize", e), this._calcDimensions()
            },
            ...
            toSVG: function(t) {
                for (var e = [], r = this._createBaseSVGMarkup(), n = 0, o = this.points.length; n < o; n++)
            ...
            _render: function(t) {
                ...
                for (var i = 0, r = this.points.length; i < r; i++)
                    e = this.points[i], t.lineTo(e.x, e.y);
        ...
        e.Polygon ? e.warn("fabric.Polygon is already defined") : (e.Polygon = e.util.createClass(e.Object, {
            ...
            _calcDimensions: function() {
                var t = this.points,
                    ...
                    o = n(t, "x"),
                    s = n(t, "y");
                this.width = o - e || 1, this.height = s - i || 1, this.left = e, this.top = i
            },
            _applyPointOffset: function() {
                this.points.forEach(function(t) {
                    t.x -= this.left + this.width / 2, t.y -= this.top + this.height / 2
                }, this)
            },
            toObject: function(t) {
            ...
            toSVG: function(t) {
                for (var e = [], i = this._createBaseSVGMarkup(), r = 0, n = this.points.length; r < n; r++)
                    e.push(o(this.points[r].x, 2), ",", o(this.points[r].y, 2), " ");
            ...
            _renderDashedStroke: function(t) {
                ...
                t.beginPath();
                for (var n = 0, o = this.points.length; n < o; n++)
                    i = this.points[n], r = this.points[n + 1] || this.points[0], e.util.drawDashedLine(t, i.x, i.y, r.x, r.y, this.strokeDashArray);
                t.closePath()
            },
            complexity: function() {
        ...
        r.Path ? r.warn("fabric.Path is already defined") : (r.Path = r.util.createClass(r.Object, {
            ...
            path: null,
            initialize: function(t, e) {
                if (e = e || {}, this.setOptions(e), !t)
                    throw new Error("`path` argument is required");
                var i = "[object Array]" === a.call(t);
                this.path = i ? t : t.match && t.match(/[mzlhvcsqta][^mzlhvcsqta]*/gi), this.path && (i || (this.path = this._parsePath()), this._initializePath(e), e.sourcePath && this.setSourcePath(e.sourcePath))
            },
            _initializePath: function(t) {
                var e = "width" in t && null != t.width,
                    ...
                    o = r ? this.left : 0,
                    a = n ? this.top : 0;
                e && i ? (n || (this.top = this.height / 2), r || (this.left = this.width / 2)) : (s(this, this._parseDimensions()), e && (this.width = t.width), i && (this.height = t.height)), this.pathOffset = this.pathOffset || this._calculatePathOffset(o, a)
            },
            ...
            _render: function(t, e) {
                ...
                for (var v = 0, b = this.path.length; v < b; ++v) {
                    switch ((i = this.path[v])[0]) {
                    case "l":
                        u += i[1], f += i[2], t.lineTo(u + g, f + m);
                        break;
                    case "L":
                        u = i[1], f = i[2], t.lineTo(u + g, f + m);
                        break;
                    case "h":
                        u += i[1], t.lineTo(u + g, f + m);
                        break;
                    case "H":
                        u = i[1], t.lineTo(u + g, f + m);
                        break;
                    case "v":
                        f += i[1], t.lineTo(u + g, f + m);
                        break;
                    case "V":
                        f = i[1], t.lineTo(u + g, f + m);
                        break;
                    case "m":
                        c = u += i[1], l = f += i[2], t.moveTo(u + g, f + m);
                        break;
                    case "M":
                        c = u = i[1], l = f = i[2], t.moveTo(u + g, f + m);
                        break;
                    case "c":
                        r = u + i[5], n = f + i[6], d = u + i[3], p = f + i[4], t.bezierCurveTo(u + i[1] + g, f + i[2] + m, d + g, p + m, r + g, n + m), u = r, f = n;
                        break;
                    case "C":
                        u = i[5], f = i[6], d = i[3], p = i[4], t.bezierCurveTo(i[1] + g, i[2] + m, d + g, p + m, u + g, f + m);
                        break;
                    case "s":
                        r = u + i[3], n = f + i[4], d = d ? 2 * u - d : u, p = p ? 2 * f - p : f, t.bezierCurveTo(d + g, p + m, u + i[1] + g, f + i[2] + m, r + g, n + m), d = u + i[1], p = f + i[2], u = r, f = n;
                        break;
                    case "S":
                        r = i[3], n = i[4], d = 2 * u - d, p = 2 * f - p, t.bezierCurveTo(d + g, p + m, i[1] + g, i[2] + m, r + g, n + m), u = r, f = n, d = i[1], p = i[2];
                        break;
                    case "q":
                        r = u + i[3], n = f + i[4], d = u + i[1], p = f + i[2], t.quadraticCurveTo(d + g, p + m, r + g, n + m), u = r, f = n;
                        break;
                    case "Q":
                        r = i[3], n = i[4], t.quadraticCurveTo(i[1] + g, i[2] + m, r + g, n + m), u = r, f = n, d = i[1], p = i[2];
                        break;
                    case "t":
                        r = u + i[1], n = f + i[2], null === a[0].match(/[QqTt]/) ? (d = u, p = f) : "t" === a[0] ? (d = 2 * u - o, p = 2 * f - s) : "q" === a[0] && (d = 2 * u - d, p = 2 * f - p), o = d, s = p, t.quadraticCurveTo(d + g, p + m, r + g, n + m), f = n, d = (u = r) + i[1], p = f + i[2];
                        break;
                    case "T":
                        r = i[1], n = i[2], d = 2 * u - d, p = 2 * f - p, t.quadraticCurveTo(d + g, p + m, r + g, n + m), u = r, f = n;
                        break;
                    case "a":
                        h(t, u + g, f + m, [i[1], i[2], i[3], i[4], i[5], i[6] + u + g, i[7] + f + m]), u += i[6], f += i[7];
                        break;
                    case "A":
                        h(t, u + g, f + m, [i[1], i[2], i[3], i[4], i[5], i[6] + g, i[7] + m]), u = i[6], f = i[7];
                        break;
                    case "z":
                    case "Z":
                        u = c, f = l, t.closePath()
            ...
            render: function(t, e) {
                if (this.visible) {
                    t.save(), e && t.translate(-this.width / 2, -this.height / 2);
                    var i = this.transformMatrix;
                    i && t.transform(i[0], i[1], i[2], i[3], i[4], i[5]), e || this.transform(t), this._setStrokeStyles(t), this._setFillStyles(t), this._setShadow(t), this.clipTo && r.util.clipContext(this, t), t.beginPath(), t.globalAlpha = this.group ? t.globalAlpha * this.opacity : this.opacity, this._render(t, e), this._renderFill(t), this._renderStroke(t), this.clipTo && t.restore(), this._removeShadow(t), t.restore()
                }
            },
            toString: function() {
            ...
            toSVG: function(t) {
                for (var e = [], i = this._createBaseSVGMarkup(), r = 0, n = this.path.length; r < n; r++)
            ...
            _parsePath: function() {
                for (var t, e, i, r, n, o = [], s = [], a = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi, h = 0, u = this.path.length; h < u; h++) {
                    for (r = (t = this.path[h]).slice(1).trim(), s.length = 0; i = a.exec(r);)
                        s.push(i[0]);
                    n = [t.charAt(0)];
                    ...
                    var p = n[0],
                        ...
                        m = l[p] || p;
                    if (n.length - 1 > g)
                        for (var v = 1, b = n.length; v < b; v += g)
                            o.push([p].concat(n.slice(v, v + g))), p = m;
                    else
                        o.push(n)
                }
                return o
            ...
            _getCoordsFromCommand: function(t, r, n, o, s) {
                var a = !1;
                "H" !== t[0] && (s.x = e(0 === r ? t : this.path[r - 1])), "V" !== t[0] && (s.y = i(0 === r ? t : this.path[r - 1])), t[0] === t[0].toLowerCase() && (a = !0);
                var h,
                    c = this._getXY(t, a, s);
                h = parseInt(c.x, 10), isNaN(h) || n.push(h), h = parseInt(c.y, 10), isNaN(h) || o.push(h)
            },
            ...
            "string" == typeof t.path ? r.loadSVGFromURL(t.path, function(i) {
                var n = i[0],
                    o = t.path;
                delete t.path, r.util.object.extend(n, t), n.setSourcePath(o), e(n)
        ...
        e.PathGroup ? e.warn("fabric.PathGroup is already defined") : (e.PathGroup = e.util.createClass(e.Path, {
            ...
            render: function(t) {
                if (this.visible) {
                    ...
                    for (var r = 0, n = this.paths.length; r < n; ++r)
                        this.paths[r].render(t, !0);
        ...
        if (!e.Group) {
            ...
            e.Group = e.util.createClass(e.Object, e.Collection, {
                ...
                initialize: function(t, e) {
                    ...
                    this.originalState = {}, this.callSuper("initialize"), this._calcBounds(), this._updateObjectsCoords(), e && i(this, e), this._setOpacityIfSame(), this.setCoords(), this.saveCoords()
                },
                ...
                _calcBounds: function(t) {
                    for (var e, i = [], r = [], n = 0, o = this._objects.length; n < o; ++n) {
                        (e = this._objects[n]).setCoords();
                        for (var s in e.oCoords)
                            i.push(e.oCoords[s].x), r.push(e.oCoords[s].y)
                    }
                ...
                _getBounds: function(t, i, o) {
                    ...
                    return o || (c.left = (a.x + h.x) / 2 || 0, c.top = (a.y + h.y) / 2 || 0), c
                },
                toSVG: function(t) {
        ...
        t.fabric || (t.fabric = {}), t.fabric.Image ? fabric.warn("fabric.Image is already defined.") : (fabric.Image = fabric.util.createClass(fabric.Object, {
            ...
            crossOrigin: "",
            initialize: function(t, e) {
                e || (e = {}), this.filters = [], this.callSuper("initialize", e), this._initElement(t, e), this._initConfig(e), e.filters && (this.filters = e.filters, this.applyFilters())
            },
            getElement: function() {
                return this._element
            },
            setElement: function(t, e) {
                return this._element = t, this._originalElement = t, this._initConfig(), 0 !== this.filters.length && this.applyFilters(e), this
            },
            ...
            applyFilters: function(t) {
                if (this._originalElement) {
                    if (0 === this.filters.length)
                        return this._element = this._originalElement, void (t && t());
                    var e = this._originalElement,
                        i = fabric.util.createCanvasElement(),
                        r = fabric.util.createImage(),
                        n = this;
                    return i.width = e.width, i.height = e.height, i.getContext("2d").drawImage(e, 0, 0, e.width, e.height), this.filters.forEach(function(t) {
                        t && t.applyTo(i)
                    }), r.width = e.width, r.height = e.height, fabric.isLikelyNode ? (r.src = i.toBuffer(undefined, fabric.Image.pngCompression), n._element = r, t && t()) : (r.onload = function() {
                        n._element = r, t && t(), r.onload = i = e = null
                    }, r.src = i.toDataURL("image/png")), this
                }
            },
            _render: function(t, e) {
                this._element && t.drawImage(this._element, e ? this.left : -this.width / 2, e ? this.top : -this.height / 2, this.width, this.height), this._renderStroke(t)
            },
    ...
    }(void 0 !== exports ? exports : this), fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.BaseFilter = fabric.util.createClass({
        type: "BaseFilter",
        toObject: function() {
            return {
                type: this.type
        ...
        e.Image.filters.Brightness = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                for (var e = t.getContext("2d"), i = e.getImageData(0, 0, t.width, t.height), r = i.data, n = this.brightness, o = 0, s = r.length; o < s; o += 4)
                    r[o] += n, r[o + 1] += n, r[o + 2] += n;
        ...
        e.Image.filters.Convolute = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                for (var e = this.matrix, i = t.getContext("2d"), r = i.getImageData(0, 0, t.width, t.height), n = Math.round(Math.sqrt(e.length)), o = Math.floor(n / 2), s = r.data, a = r.width, h = r.height, c = a, l = h, u = this._createImageData(c, l), f = u.data, d = this.opaque ? 1 : 0, p = 0; p < l; p++)
                    for (var g = 0; g < c; g++) {
                        for (var m = p, v = g, b = 4 * (p * c + g), y = 0, x = 0, w = 0, S = 0, C = 0; C < n; C++)
                            for (var _ = 0; _ < n; _++) {
                                var T = m + C - o,
                                    O = v + _ - o;
                                if (!(T < 0 || T > h || O < 0 || O > a)) {
                                    var k = 4 * (T * a + O),
                                        E = e[C * n + _];
                                    y += s[k] * E, x += s[k + 1] * E, w += s[k + 2] * E, S += s[k + 3] * E
                                }
                            }
                        f[b] = y, f[b + 1] = x, f[b + 2] = w, f[b + 3] = S + d * (255 - S)
                    }
        ...
        e.Image.filters.GradientTransparency = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                for (var e = t.getContext("2d"), i = e.getImageData(0, 0, t.width, t.height), r = i.data, n = this.threshold, o = r.length, s = 0, a = r.length; s < a; s += 4)
                    r[s + 3] = n + 255 * (o - s) / o;
                e.putImageData(i, 0, 0)
            },
            toObject: function() {
        ...
        e.Image.filters.Grayscale = e.util.createClass(e.Image.filters.BaseFilter, {
            type: "Grayscale",
            applyTo: function(t) {
                for (var e, i = t.getContext("2d"), r = i.getImageData(0, 0, t.width, t.height), n = r.data, o = r.width * r.height * 4, s = 0; s < o;)
                    e = (n[s] + n[s + 1] + n[s + 2]) / 3, n[s] = e, n[s + 1] = e, n[s + 2] = e, s += 4;
        ...
        e.Image.filters.Noise = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                for (var e, i = t.getContext("2d"), r = i.getImageData(0, 0, t.width, t.height), n = r.data, o = this.noise, s = 0, a = n.length; s < a; s += 4)
                    e = (.5 - Math.random()) * o, n[s] += e, n[s + 1] += e, n[s + 2] += e;
                i.putImageData(r, 0, 0)
            },
            toObject: function() {
                return i(this.callSuper("toObject"), {
            ...
            applyTo: function(t) {
                ...
                for (i = 0; i < u; i += this.blocksize)
                    for (r = 0; r < f; r += this.blocksize) {
                        n = l[e = 4 * i * f + 4 * r], o = l[e + 1], s = l[e + 2], a = l[e + 3];
                        for (var d = i, p = i + this.blocksize; d < p; d++)
                            for (var g = r, m = r + this.blocksize; g < m; g++)
                                l[e = 4 * d * f + 4 * g] = n, l[e + 1] = o, l[e + 2] = s, l[e + 3] = a
                    }
        ...
        e.Image.filters.RemoveWhite = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                for (var e, i, r, n = t.getContext("2d"), o = n.getImageData(0, 0, t.width, t.height), s = o.data, a = this.threshold, h = this.distance, c = 255 - a, l = Math.abs, u = 0, f = s.length; u < f; u += 4)
                    e = s[u], i = s[u + 1], r = s[u + 2], e > c && i > c && r > c && l(e - i) < h && l(e - r) < h && l(i - r) < h && (s[u + 3] = 1);
        ...
        e.Image.filters.Sepia = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                var e,
                    ...
                    s = o.length;
                for (e = 0; e < s; e += 4)
                    i = .3 * o[e] + .59 * o[e + 1] + .11 * o[e + 2], o[e] = i + 100, o[e + 1] = i + 50, o[e + 2] = i + 255;
                r.putImageData(n, 0, 0)
            }
        ...
        e.Image.filters.Sepia2 = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                var e,
                    ...
                    h = a.length;
                for (e = 0; e < h; e += 4)
                    i = a[e], r = a[e + 1], n = a[e + 2], a[e] = (.393 * i + .769 * r + .189 * n) / 1.351, a[e + 1] = (.349 * i + .686 * r + .168 * n) / 1.203, a[e + 2] = (.272 * i + .534 * r + .131 * n) / 2.14;
        ...
        e.Image.filters.Tint = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                var i,
                    ...
                    d = f.data,
                    p = d.length;
                for (r = (l = new e.Color(this.color).getSource())[0] * this.opacity, n = l[1] * this.opacity, o = l[2] * this.opacity, c = 1 - this.opacity, i = 0; i < p; i += 4)
                    s = d[i], a = d[i + 1], h = d[i + 2], d[i] = r + s * c, d[i + 1] = n + a * c, d[i + 2] = o + h * c;
        ...
        e.Image.filters.Multiply = e.util.createClass(e.Image.filters.BaseFilter, {
            ...
            applyTo: function(t) {
                ...
                for (r = new e.Color(this.color).getSource(), i = 0; i < a; i += 4)
                    s[i] *= r[0] / 255, s[i + 1] *= r[1] / 255, s[i + 2] *= r[2] / 255;
                n.putImageData(o, 0, 0)
            },
            toObject: function() {
                return i(this.callSuper("toObject"), {
        ...
        e.Image.filters.Blend = e.util.createClass({
            ...
            applyTo: function(t) {
                ...
                if (this.image) {
                    ...
                    p.add(this.image), h = p.getContext("2d").getImageData(0, 0, p.width, p.height).data
                } else
                    i = (h = new e.Color(this.color).getSource())[0] * this.alpha, r = h[1] * this.alpha, n = h[2] * this.alpha;
                for (var g = 0, m = u.length; g < m; g += 4)
                    switch (o = u[g], s = u[g + 1], a = u[g + 2], f && (i = h[g] * this.alpha, r = h[g + 1] * this.alpha, n = h[g + 2] * this.alpha), this.mode) {
                    case "multiply":
                        u[g] = o * i / 255, u[g + 1] = s * r / 255, u[g + 2] = a * n / 255;
                        break;
                    case "screen":
                        u[g] = 1 - (1 - o) * (1 - i), u[g + 1] = 1 - (1 - s) * (1 - r), u[g + 2] = 1 - (1 - a) * (1 - n);
                        break;
                    case "add":
                        u[g] = Math.min(255, o + i), u[g + 1] = Math.min(255, s + r), u[g + 2] = Math.min(255, a + n);
                        break;
                    case "diff":
                    case "difference":
                        u[g] = Math.abs(o - i), u[g + 1] = Math.abs(s - r), u[g + 2] = Math.abs(a - n);
                        break;
                    case "subtract":
                        var v = o - i,
                            b = s - r,
                            y = a - n;
                        u[g] = v < 0 ? 0 : v, u[g + 1] = b < 0 ? 0 : b, u[g + 2] = y < 0 ? 0 : y;
                        break;
                    case "darken":
                        u[g] = Math.min(o, i), u[g + 1] = Math.min(s, r), u[g + 2] = Math.min(a, n);
                        break;
                    case "lighten":
                        u[g] = Math.max(o, i), u[g + 1] = Math.max(s, r), u[g + 2] = Math.max(a, n)
                    }
        ...
        if (e.Text)
            ...
            s.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "textBackgroundColor", "useNative", "path"), e.Text = e.util.createClass(e.Object, {
                ...
                _renderViaNative: function(t) {
                    ...
                    this._setTextStyles(t), this.width = this._getTextWidth(t, i), this.height = this._getTextHeight(t, i), this.clipTo && e.util.clipContext(this, t), this._renderTextBackground(t, i), this._translateForTextAlign(t), this._renderText(t, i), "left" !== this.textAlign && "justify" !== this.textAlign && t.restore(), this._renderTextDecoration(t, i), this.clipTo && t.restore(), this._setBoundaries(t, i), this._totalLineHeight = 0
                },
                _renderText: function(t, e) {
                    t.save(), this._setShadow(t), this._setupFillRule(t), this._renderTextFill(t, e), this._renderTextStroke(t, e), this._restoreFillRule(t), this._removeShadow(t), t.restore()
                },
                ...
                _renderTextLine: function(t, e, i, r, n, o) {
                    if (n -= this.fontSize / 4, "justify" === this.textAlign) {
                        var s = e.measureText(i).width,
                            a = this.width;
                        if (a > s)
                            for (var h = i.split(/\s+/), c = (a - e.measureText(i.replace(/\s+/g, "")).width) / (h.length - 1), l = 0, u = 0, f = h.length; u < f; u++)
                                this._renderChars(t, e, h[u], r + l, n, o), l += e.measureText(h[u]).width + c;
                        else
                ...
                _renderTextFill: function(t, e) {
                    if (this.fill || this._skipFillStrokeCheck) {
                        this._boundaries = [];
                        for (var i = 0, r = 0, n = e.length; r < n; r++)
                            i += this._getHeightOfLine(t, r, e), this._renderTextLine("fillText", t, e[r], this._getLeftOffset(), this._getTopOffset() + i, r)
                    }
                },
                _renderTextStroke: function(t, e) {
                    if (this.stroke && 0 !== this.strokeWidth || this._skipFillStrokeCheck) {
                        ...
                        for (var r = 0, n = e.length; r < n; r++)
                            i += this._getHeightOfLine(t, r, e), this._renderTextLine("strokeText", t, e[r], this._getLeftOffset(), this._getTopOffset() + i, r);
                ...
                render: function(t, e) {
                    if (this.visible) {
                        t.save(), this._transform(t, e);
                        var i = this.transformMatrix,
                            r = this.group && "path-group" === this.group.type;
                        r && t.translate(-this.group.width / 2, -this.group.height / 2), i && t.transform(i[0], i[1], i[2], i[3], i[4], i[5]), r && t.translate(this.left, this.top), this._render(t), t.restore()
                    }
                },
                toObject: function(t) {
                    var e = i(this.callSuper("toObject", t), {
                ...
                toSVG: function(t) {
                    ...
                    return r.textTop += this._fontAscent ? this._fontAscent / 5 * this.lineHeight : 0, this._wrapSVGTextAndBg(e, n, o, r), t ? t(e.join("")) : e.join("")
                },
                ...
                _getSVGShadows: function(t, i) {
                    ...
                    for (r = 0, o = i.length; r < o; r++)
                        if ("" !== i[r]) {
                            ...
                            s.push('<tspan x="', n(h + a + this.shadow.offsetX, 2), 0 === r || this.useNative ? '" y' : '" dy', '="', n(this.useNative ? t * r - this.height / 2 + this.shadow.offsetY : t + (0 === r ? this.shadow.offsetY : 0), 2), '" ', this._getFillAttributes(this.shadow.color), ">", e.util.string.escapeXml(i[r]), "</tspan>"), a = 1
                        } else
                            a++;
                    return s
                },
                _getSVGTextAndBg: function(t, e, i) {
                    ...
                    for (var s = 0, a = i.length; s < a; s++)
                        "" !== i[s] ? (this._setSVGTextLineText(i[s], s, r, t, o, n), o = 1) : o++, this.textBackgroundColor && this._boundaries && this._setSVGTextLineBg(n, s, e, t);
                    return {
                        textSpans: r,
                        textBgRects: n
                    }
                ...
                _set: function(t, e) {
                    "fontFamily" === t && this.path && (this.path = this.path.replace(/(.*?)([^\/]*)(\.font\.js)/, "$1" + e + "$3")), this.callSuper("_set", t, e), t in this._dimensionAffectingProps && (this._initDimensions(), this.setCoords())
                },
                complexity: function() {
                    return 1
                }
                ...
                i = e.util.object.extend(i ? e.util.object.clone(i) : {}, r), "dx" in r && (i.left += r.dx), "dy" in r && (i.top += r.dy), "fontSize" in i || (i.fontSize = e.Text.DEFAULT_SVG_FONT_SIZE), i.originX || (i.originX = "left");
                var n = new e.Text(t.textContent, i),
                    o = 0;
                return "left" === n.originX && (o = n.getWidth() / 2), "right" === n.originX && (o = -n.getWidth() / 2), n.set({
                    left: n.getLeft() + o,
