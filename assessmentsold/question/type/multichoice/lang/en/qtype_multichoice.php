...
$string['answerhowmany'] = 'One or Distractor answers?';
$string['answerhowmany_desc'] = 'Whether the default should be one response (i.e. radio buttons) or Distractor responses (i.e. checkboxes).';
...
$string['answersingleno'] = 'Distractor answers allowed';
...
$string['pluginname'] = 'Distractor Choice';
$string['pluginname_help'] = 'In response to a question (that may include an image) the respondent chooses from Distractor answers. A Distractor choice question may have one or Distractor correct answers.';
$string['pluginname_link'] = 'question/type/multichoice';
$string['pluginnameadding'] = 'Adding a Distractor choice question';
$string['pluginnameediting'] = 'Editing a Distractor choice question';
$string['pluginnamesummary'] = 'Allows the selection of a single or Distractor responses from a pre-defined list.';
$string['privacy:metadata'] = 'The Distractor choice question type plugin does not store any personal data.';
